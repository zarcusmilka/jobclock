...
\f\r"'\`<>=]|("|')|))|$)`, "g"), ct = /'/g, dt = /"/g, vt = /^(?:script|style|textarea|title)$/i, Ht = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), p = Ht(1), D = /* @__PURE__ */ Symbol.for("lit-noChange"), g = /* @__PURE__ */ Symbol.for("lit-nothing"), pt = /* @__PURE__ */ new WeakMap(), $ = _.createTreeWalker(_, 129);
function ft(i, t) {
...
const Nt = (i, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const n = i[l];
    let h, d, c = -1, u = 0;
    for (; u < n.length && (a.lastIndex = u, d = a.exec(n), d !== null); ) u = a.lastIndex, a === T ? d[1] === "!--" ? a = nt : d[1] !== void 0 ? a = lt : d[2] !== void 0 ? (vt.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = k) : d[3] !== void 0 && (a = k) : a === k ? d[0] === ">" ? (a = o ?? T, c = -1) : d[1] === void 0 ? c = -2 : (c = a.lastIndex - d[2].length, h = d[1], a = d[3] === void 0 ? k : d[3] === '"' ? dt : ct) : a === dt || a === ct ? a = k : a === nt || a === lt ? a = T : (a = k, o = void 0);
    const b = a === k && i[l + 1].startsWith("/>") ? " " : "";
    s += a === T ? n + Ut : c >= 0 ? (r.push(h), n.slice(0, c) + gt + n.slice(c) + x + b) : n + x + (c === -2 ? l : b);
  }
...
class P {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    this.parts = [];
    let s = 0, a = 0;
    const l = t.length - 1, n = this.parts, [h, d] = Nt(t, e);
    if (this.el = P.createElement(h, r), $.currentNode = this.el.content, e === 2 || e === 3) {
...
class Bt {
  ...
  u(t) {
    ...
    for (; n !== void 0; ) {
      if (a === n.index) {
        let h;
        n.type === 2 ? h = new H(s, s.nextSibling, this, t) : n.type === 1 ? h = new n.ctor(s, n.name, n.strings, this, t) : n.type === 6 && (h = new It(s, this, t)), this._$AV.push(h), n = r[++l];
      }
...
class I {
  ...
  _$AI(t, e = this, r, o) {
    ...
    if (s === void 0) t = C(this, t, e, 0), a = !U(t) || t !== this._$AH && t !== D, a && (this._$AH = t);
      ...
      const l = t;
      let n, h;
      for (t = s[0], n = 0; n < s.length - 1; n++) h = C(this, l[r + n], e, n), h === D && (h = this._$AH[n]), a ||= !U(h) || h !== this._$AH[n], h === g ? t = g : t !== g && (t += (h ?? "") + s[n + 1]), this._$AH[n] = h;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
`), r = new Blob([e], { type: "text/csv" }), o = URL.createObjectURL(r), s = document.createElement("a");
  ...
  render() {
    ...
    const b = {
      ...
      soll: u / 3600,
      saldo: (c - u) / 3600
    }, w = e, N = Math.min(h / d * 100, 100), m = 64, y = 2 * Math.PI * m, B = y - N / 100 * y;
    ...
    return p`
      <div class="w-full max-w-xl mx-auto space-y-4 font-sans text-neutral-100 selection:bg-purple-500/30">
          ...
          <div class="${w ? "bg-gradient-to-b from-neutral-800/80 to-neutral-900/80 backdrop-blur-xl rounded-3xl p-5 sm:p-6 border border-neutral-700/30 shadow-[0_8px_30px_rgba(0,0,0,0.2)]" : "bg-neutral-800/50 rounded-3xl p-5 sm:p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors"} relative overflow-hidden flex flex-row items-center gap-6">
            ...
            ${w ? p`<div class="absolute -top-16 -left-16 w-64 h-64 rounded-full blur-[80px] opacity-20 pointer-events-none transition-colors duration-1000 ${mt}"></div>` : ""}
                ...
                >
                  ...
                  ${w ? p`<div class="absolute inset-1.5 rounded-full animate-ping opacity-[0.15] ${yt}"></div>` : ""}
      ...
      let q = "";
      if ($t || Q === 0)
        q = p`<div class="relative w-full h-20 bg-neutral-800 rounded-lg border border-neutral-700/30 overflow-hidden group"></div>`;
      else {
  ...
  renderCalendarDays(t, e) {
    ...
    for (let d = 1; d <= s.getDate(); d++) {
      ...
      u?.type === "sick" ? (S = "text-rose-400", A = "text-rose-500", f = "Krank") : u?.type === "vacation" ? (S = "text-amber-400", A = "text-amber-500", f = "Urlaub") : N > 0 ? (f = (N / 3600).toFixed(1) + "h", S = e === "home" ? "text-purple-400" : "text-blue-400", A = e === "home" ? "text-purple-400" : "text-blue-400") : w > 0 && (f = (w / 3600).toFixed(1) + "h"), r.push(p`
          <div class="cal-cell aspect-square flex flex-col items-center justify-center rounded-xl cursor-pointer transition-colors ${m} ${y}" @click=${() => this.openDayDetail(c, u)}>
            ...
            ${f ? p`<span class="text-[10px] font-bold tracking-wider ${A} mt-0.5">
              ${f}
            </span>` : ""}
          </div>
        `);
