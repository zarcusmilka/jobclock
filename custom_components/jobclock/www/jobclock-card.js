const J = globalThis, rt = J.ShadowRoot && (J.ShadyCSS === void 0 || J.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, yt = /* @__PURE__ */ Symbol(), dt = /* @__PURE__ */ new WeakMap();
let Ot = class {
  constructor(t, e, r) {
...
const kt = (i) => new Ot(typeof i == "string" ? i : i + "", void 0, yt), zt = (i, t) => {
...
}, pt = rt ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const r of t.cssRules) e += r.cssText;
  return kt(e);
})(i) : i;
const { is: jt, defineProperty: Ut, getOwnPropertyDescriptor: Ht, getOwnPropertyNames: Pt, getOwnPropertySymbols: Nt, getPrototypeOf: Bt } = Object, G = globalThis, ht = G.trustedTypes, Rt = ht ? ht.emptyScript : "", Ft = G.reactiveElementPolyfillSupport, B = (i, t) => i, et = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Rt : null;
      break;
  ...
  return e;
} }, $t = (i, t) => !jt(i, t), ut = { attribute: !0, type: String, converter: et, reflect: !1, useDefault: !1, hasChanged: $t };
...
let O = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, r) {
    const { get: o, set: s } = Ht(this.prototype, t) ?? { get() {
      return this[e];
    }, set(a) {
      this[e] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(B("properties"))) {
      const e = this.properties, r = [...Pt(e), ...Nt(e)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const o of r) e.unshift(pt(o));
  ...
  _$ET(t, e) {
    ...
    if (o !== void 0 && r.reflect === !0) {
      const s = (r.converter?.toAttribute !== void 0 ? r.converter : et).toAttribute(e, r.type);
  ...
  _$AK(t, e) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const s = r.getPropertyOptions(o), a = typeof s.converter == "function" ? { fromAttribute: s.converter } : s.converter?.fromAttribute !== void 0 ? s.converter : et;
      this._$Em = o;
  ...
  requestUpdate(t, e, r, o = !1, s) {
    if (t !== void 0) {
      ...
      if (o === !1 && (s = this[t]), r ??= a.getPropertyOptions(t), !((r.hasChanged ?? $t)(s, e) || r.useDefault && r.reflect && s === this._$Ej?.get(t) && !this.hasAttribute(a._$Eu(t, r)))) return;
      this.C(t, e, r);
    }
...
O.elementStyles = [], O.shadowRootOptions = { mode: "open" }, O[B("elementProperties")] = /* @__PURE__ */ new Map(), O[B("finalized")] = /* @__PURE__ */ new Map(), Ft?.({ ReactiveElement: O }), (G.reactiveElementVersions ??= []).push("2.1.2");
const ot = globalThis, bt = (i) => i, K = ot.trustedTypes, gt = K ? K.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, _t = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, St = "?" + y, Lt = `<${St}>`, A = document, F = () => A.createComment(""), L = (i) => i === null || typeof i != "object" && typeof i != "function", at = Array.isArray, It = (i) => at(i) || typeof i?.[Symbol.iterator] == "function", tt = `[ 	
\f\r]`, N = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, wt = /-->/g, vt = />/g, _ = RegExp(`>|${tt}(?:([^\\s"'>=/]+)(${tt}*=${tt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ft = /'/g, xt = /"/g, At = /^(?:script|style|textarea|title)$/i, Wt = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), p = Wt(1), z = /* @__PURE__ */ Symbol.for("lit-noChange"), g = /* @__PURE__ */ Symbol.for("lit-nothing"), mt = /* @__PURE__ */ new WeakMap(), S = A.createTreeWalker(A, 129);
function Mt(i, t) {
...
const qt = (i, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const n = i[l];
    let h, d, c = -1, u = 0;
    for (; u < n.length && (a.lastIndex = u, d = a.exec(n), d !== null); ) u = a.lastIndex, a === N ? d[1] === "!--" ? a = wt : d[1] !== void 0 ? a = vt : d[2] !== void 0 ? (At.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = _) : d[3] !== void 0 && (a = _) : a === _ ? d[0] === ">" ? (a = o ?? N, c = -1) : d[1] === void 0 ? c = -2 : (c = a.lastIndex - d[2].length, h = d[1], a = d[3] === void 0 ? _ : d[3] === '"' ? xt : ft) : a === xt || a === ft ? a = _ : a === wt || a === vt ? a = N : (a = _, o = void 0);
    const b = a === _ && i[l + 1].startsWith("/>") ? " " : "";
    s += a === N ? n + Lt : c >= 0 ? (r.push(h), n.slice(0, c) + _t + n.slice(c) + y + b) : n + y + (c === -2 ? l : b);
  }
  return [Mt(i, s + (i[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class I {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    this.parts = [];
    let s = 0, a = 0;
    const l = t.length - 1, n = this.parts, [h, d] = qt(t, e);
    if (this.el = I.createElement(h, r), S.currentNode = this.el.content, e === 2 || e === 3) {
      const c = this.el.content.firstChild;
      c.replaceWith(...c.childNodes);
    }
    for (; (o = S.nextNode()) !== null && n.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const c of o.getAttributeNames()) if (c.endsWith(_t)) {
          const u = d[a++], b = o.getAttribute(c).split(y), w = /([.?@])?(.*)/.exec(u);
          n.push({ type: 1, index: s, name: w[2], strings: b, ctor: w[1] === "." ? Yt : w[1] === "?" ? Jt : w[1] === "@" ? Kt : Z }), o.removeAttribute(c);
        } else c.startsWith(y) && (n.push({ type: 6, index: s }), o.removeAttribute(c));
        if (At.test(o.tagName)) {
          const c = o.textContent.split(y), u = c.length - 1;
          if (u > 0) {
            o.textContent = K ? K.emptyScript : "";
            for (let b = 0; b < u; b++) o.append(c[b], F()), S.nextNode(), n.push({ type: 2, index: ++s });
            o.append(c[u], F());
          }
        }
      } else if (o.nodeType === 8) if (o.data === St) n.push({ type: 2, index: s });
      else {
        let c = -1;
        for (; (c = o.data.indexOf(y, c + 1)) !== -1; ) n.push({ type: 7, index: s }), c += y.length - 1;
      }
      s++;
    }
  }
...
function j(i, t, e = i, r) {
  if (t === z) return t;
  let o = r !== void 0 ? e._$Co?.[r] : e._$Cl;
  const s = L(t) ? void 0 : t._$litDirective$;
  return o?.constructor !== s && (o?._$AO?.(!1), s === void 0 ? o = void 0 : (o = new s(i), o._$AT(i, e, r)), r !== void 0 ? (e._$Co ??= [])[r] = o : e._$Cl = o), o !== void 0 && (t = j(i, o._$AS(i, t.values), o, r)), t;
}
class Vt {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: r } = this._$AD, o = (t?.creationScope ?? A).importNode(e, !0);
    S.currentNode = o;
    let s = S.nextNode(), a = 0, l = 0, n = r[0];
    for (; n !== void 0; ) {
      if (a === n.index) {
        let h;
        n.type === 2 ? h = new W(s, s.nextSibling, this, t) : n.type === 1 ? h = new n.ctor(s, n.name, n.strings, this, t) : n.type === 6 && (h = new Gt(s, this, t)), this._$AV.push(h), n = r[++l];
      }
...
class W {
  ...
  _$AI(t, e = this) {
    t = j(this, t, e), L(t) ? t === g || t == null || t === "" ? (this._$AH !== g && this._$AR(), this._$AH = g) : t !== this._$AH && t !== z && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : It(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: e, _$litType$: r } = t, o = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = I.createElement(Mt(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === o) this._$AH.p(e);
    else {
      const s = new Vt(o, this), a = s.u(this.options);
...
class Z {
  ...
  _$AI(t, e = this, r, o) {
    ...
    let a = !1;
    if (s === void 0) t = j(this, t, e, 0), a = !L(t) || t !== this._$AH && t !== z, a && (this._$AH = t);
    else {
      const l = t;
      let n, h;
      for (t = s[0], n = 0; n < s.length - 1; n++) h = j(this, l[r + n], e, n), h === z && (h = this._$AH[n]), a ||= !L(h) || h !== this._$AH[n], h === g ? t = g : t !== g && (t += (h ?? "") + s[n + 1]), this._$AH[n] = h;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
Zt?.(I, W), (ot.litHtmlVersions ??= []).push("3.3.2");
const Qt = (i, t, e) => {
...
class re extends (customElements.get("ha-panel-lovelace") ? R : HTMLElement) {
...
`), r = new Blob([e], { type: "text/csv" }), o = URL.createObjectURL(r), s = document.createElement("a");
  ...
  render() {
    ...
    const n = this._data[m(/* @__PURE__ */ new Date())] || { duration: 0, target: 0 }, h = (n.duration || 0) + l, d = n.target || 8 * 3600;
    let c = 0, u = 0;
    ...
    const b = {
      ...
      soll: u / 3600,
      saldo: (c - u) / 3600
    }, w = e, q = Math.min(h / d * 100, 100), k = 64, $ = 2 * Math.PI * k, V = $ - q / 100 * $;
    (/* @__PURE__ */ new Date()).toLocaleDateString("de-DE", { day: "numeric", month: "long" });
    const Q = this._currentMonth.toLocaleDateString("de-DE", { month: "short" }).toUpperCase(), M = this._currentMonth.toLocaleDateString("de-DE", { month: "long", year: "numeric" }), D = ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"], f = /* @__PURE__ */ new Date(), st = f.getDay(), Dt = st === 0 ? -6 : 1 - st, Y = new Date(f);
    Y.setDate(f.getDate() + Dt), Y.setHours(0, 0, 0, 0);
    const nt = [];
    let lt = 0, ct = 0;
    for (let v = 0; v < 7; v++) {
      const E = new Date(Y);
      E.setDate(Y.getDate() + v);
      const U = m(E), x = this._data[U], H = E.getDay(), C = H === 0 || H === 6;
      let T = 0, P = 0, X = C ? "weekend" : "work";
      x ? (T = (x.duration || 0) / 3600, P = (x.target || 0) / 3600, x.type && (X = x.type === "weekend" ? "weekend" : x.type)) : C || (P = 8), U === m(f) && e && l > 0 && (T += l / 3600), lt += T, ct += P, nt.push({ label: D[E.getDay()], duration: T, target: P, type: X });
    }
    const Et = a === "home" ? "bg-purple-500" : "bg-blue-500", Ct = a === "home" ? "bg-purple-400" : "bg-blue-400", Tt = a === "home" ? "stroke-purple-500" : "stroke-blue-500";
    return p`
          ...
          <div class="${w ? "bg-gradient-to-b from-neutral-800/80 to-neutral-900/80 backdrop-blur-xl rounded-3xl p-5 sm:p-6 border border-neutral-700/30 shadow-[0_8px_30px_rgba(0,0,0,0.2)]" : "bg-neutral-800/50 rounded-3xl p-5 sm:p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors"} relative overflow-hidden flex flex-row items-center gap-6">
            ...
            ${w ? p`<div class="absolute -top-16 -left-16 w-64 h-64 rounded-full blur-[80px] opacity-20 pointer-events-none transition-colors duration-1000 ${Et}"></div>` : ""}
                ...
                >
                  ...
                  ${w ? p`<div class="absolute inset-1.5 rounded-full animate-ping opacity-[0.15] ${Ct}"></div>` : ""}
                  ...
                  <svg class="absolute inset-0 w-full h-full transform -rotate-90 drop-shadow-xl z-20" viewBox="0 0 160 160" style="pointer-events: none;">
                    ...
                    <circle cx="80" cy="80" r="${k}" class="stroke-neutral-800" stroke-width="8" fill="transparent" />
                    <circle
                      cx="80" cy="80" r="${k}"
                      class="transition-all duration-1000 ease-out ${Tt}"
                      stroke-width="8" stroke-linecap="round" fill="transparent" stroke-dasharray="${$}" stroke-dashoffset="${V}"
                  ...
                  <div class="absolute flex flex-col items-center justify-center text-center mt-1 z-30">
                    <div class="mb-1 transition-colors duration-300 ${w ? a === "home" ? "text-purple-400" : "text-blue-400" : "text-neutral-400 group-hover:text-purple-400"}">
                       ${w ? p`<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><rect width="18" height="18" x="3" y="3" rx="2"/></svg>` : p`<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><polygon points="6 3 20 12 6 21 6 3"/></svg>`}
                    </div>
          ...
          <div class="bg-neutral-800/50 rounded-3xl p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="px-2.5 py-1 rounded-md bg-[#2a1a3e] border border-purple-500/20 text-purple-300 text-[10px] font-bold tracking-widest font-mono">
                    ${lt.toFixed(1)} / ${ct.toFixed(1)}h
                </div>
            </div>

            <div class="flex justify-between items-end h-28 gap-2 mt-6">
                ${nt.map((v) => {
      const E = v.type === "weekend", U = v.target, x = v.duration, H = v.label === ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"][(/* @__PURE__ */ new Date()).getDay()];
      let C = "";
      if (E || U === 0)
        C = p`<div class="relative w-full h-20 bg-neutral-800 rounded-lg border border-neutral-700/30 overflow-hidden group"></div>`;
      else {
        const T = Math.min(x / Math.max(U, 1) * 100, 100);
        C = p`
                        <div class="relative w-full flex flex-col justify-end h-20 bg-neutral-800 rounded-lg border ${H ? "border-neutral-500/50" : "border-neutral-700/30"} overflow-hidden group">
                            <div class="w-full ${a === "home" ? "bg-purple-500" : "bg-blue-500"} rounded-b-lg transition-all duration-1000 ease-out" style="height: ${T}%"></div>
      ...
      return p`
                    <div class="flex flex-col items-center gap-2 flex-1 h-full">
                        ...
                        <span class="text-[11px] font-semibold ${H ? "text-white" : "text-neutral-500"}">${v.label}</span>
                    </div>
                   `;
    })}
            </div>
          ...
          <div class="calendar bg-neutral-800/50 rounded-3xl p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors">
            <div class="cal-nav flex justify-between items-center mb-6 px-2">
              ...
              <span class="cal-title font-bold text-white">${M}</span>
              <button class="nav-btn p-2 hover:bg-neutral-800 rounded-full transition-colors text-white" @click=${() => this.changeMonth(1)}>
                 <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m9 18 6-6-6-6"/></svg>
              </button>
            </div>
            <div class="cal-grid grid grid-cols-7 gap-1.5 sm:gap-2">
              ${["Mo", "Di", "Mi", "Do", "Fr", "Sa", "So"].map((v) => p`<div class="cal-hdr text-center text-[10px] font-bold text-neutral-500 mb-2">${v}</div>`)}
  ...
  renderCalendarDays(t, e) {
    ...
    for (let d = 1; d <= s.getDate(); d++) {
      const c = m(new Date(t.getFullYear(), t.getMonth(), d)), u = this._data[c], b = c === a, w = u?.target || 0, q = u?.duration || 0;
      let k = "bg-neutral-800/40 hover:bg-neutral-700/80", $ = "border border-neutral-700/30";
      b && ($ = e === "home" ? "border border-purple-500/80 bg-purple-500/10 shadow-[0_0_15px_rgba(168,85,247,0.15)]" : "border border-blue-500/80 bg-blue-500/10 shadow-[0_0_15px_rgba(59,130,246,0.15)]");
      let V = "text-sm", Q = "font-bold", M = "text-neutral-400", D = "text-neutral-500", f = "";
      u?.type === "sick" ? (M = "text-rose-400", D = "text-rose-500", f = "Krank") : u?.type === "vacation" ? (M = "text-amber-400", D = "text-amber-500", f = "Urlaub") : q > 0 ? (f = (q / 3600).toFixed(1) + "h", M = e === "home" ? "text-purple-400" : "text-blue-400", D = e === "home" ? "text-purple-400" : "text-blue-400") : w > 0 && (f = (w / 3600).toFixed(1) + "h"), r.push(p`
          <div class="cal-cell aspect-square flex flex-col items-center justify-center rounded-xl cursor-pointer transition-colors ${k} ${$}" @click=${() => this.openDayDetail(c, u)}>
            <span class="${V} ${Q} ${M}">${d}</span>
            ${f ? p`<span class="text-[10px] font-bold tracking-wider ${D} mt-0.5">
              ${f}
            </span>` : ""}
          </div>
        `);
      ...
      <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-md transition-all" @click=${this.closeDayDetail}>
        <div class="bg-[#1a1f2b] border border-neutral-700/50 rounded-[2rem] w-full max-w-sm shadow-2xl overflow-hidden flex flex-col" @click=${(a) => a.stopPropagation()}>
          ...
          <div class="px-6 pt-6 pb-4 flex justify-between items-center relative">
            <h3 class="text-lg font-bold text-white">${ee(this._detailDate)}</h3>
...
customElements.define("jobclock-card", re);
