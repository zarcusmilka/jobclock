const X = globalThis, st = X.ShadowRoot && (X.ShadyCSS === void 0 || X.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Mt = /* @__PURE__ */ Symbol(), wt = /* @__PURE__ */ new WeakMap();
let Bt = class {
  constructor(t, e, r) {
...
const Dt = (i) => new Bt(typeof i == "string" ? i : i + "", void 0, Mt), Rt = (i, t) => {
  if (st) i.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const r = document.createElement("style"), o = X.litNonce;
...
const { is: Ft, defineProperty: Lt, getOwnPropertyDescriptor: It, getOwnPropertyNames: Wt, getOwnPropertySymbols: qt, getPrototypeOf: Vt } = Object, et = globalThis, ft = et.trustedTypes, Kt = ft ? ft.emptyScript : "", Yt = et.reactiveElementPolyfillSupport, I = (i, t) => i, it = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Kt : null;
      break;
  ...
  return e;
} }, Et = (i, t) => !Ft(i, t), xt = { attribute: !0, type: String, converter: it, reflect: !1, useDefault: !1, hasChanged: Et };
...
let U = class extends HTMLElement {
  ...
  _$ET(t, e) {
    ...
    if (o !== void 0 && r.reflect === !0) {
      const s = (r.converter?.toAttribute !== void 0 ? r.converter : it).toAttribute(e, r.type);
  ...
  _$AK(t, e) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const s = r.getPropertyOptions(o), a = typeof s.converter == "function" ? { fromAttribute: s.converter } : s.converter?.fromAttribute !== void 0 ? s.converter : it;
      this._$Em = o;
  ...
  requestUpdate(t, e, r, o = !1, s) {
    if (t !== void 0) {
      ...
      if (o === !1 && (s = this[t]), r ??= a.getPropertyOptions(t), !((r.hasChanged ?? Et)(s, e) || r.useDefault && r.reflect && s === this._$Ej?.get(t) && !this.hasAttribute(a._$Eu(t, r)))) return;
      this.C(t, e, r);
    }
...
U.elementStyles = [], U.shadowRootOptions = { mode: "open" }, U[I("elementProperties")] = /* @__PURE__ */ new Map(), U[I("finalized")] = /* @__PURE__ */ new Map(), Yt?.({ ReactiveElement: U }), (et.reactiveElementVersions ??= []).push("2.1.2");
const nt = globalThis, mt = (i) => i, tt = nt.trustedTypes, yt = tt ? tt.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Ct = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, Tt = "?" + _, Jt = `<${Tt}>`, E = document, q = () => E.createComment(""), V = (i) => i === null || typeof i != "object" && typeof i != "function", lt = Array.isArray, Gt = (i) => lt(i) || typeof i?.[Symbol.iterator] == "function", at = `[ 	
\f\r]`, L = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, kt = /-->/g, _t = />/g, M = RegExp(`>|${at}(?:([^\\s"'>=/]+)(${at}*=${at}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), $t = /'/g, St = /"/g, Ot = /^(?:script|style|textarea|title)$/i, Zt = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), p = Zt(1), P = /* @__PURE__ */ Symbol.for("lit-noChange"), w = /* @__PURE__ */ Symbol.for("lit-nothing"), At = /* @__PURE__ */ new WeakMap(), D = E.createTreeWalker(E, 129);
function zt(i, t) {
...
const Qt = (i, t) => {
  ...
  let o, s = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", a = L;
  for (let l = 0; l < e; l++) {
    const n = i[l];
    let u, d, c = -1, b = 0;
    for (; b < n.length && (a.lastIndex = b, d = a.exec(n), d !== null); ) b = a.lastIndex, a === L ? d[1] === "!--" ? a = kt : d[1] !== void 0 ? a = _t : d[2] !== void 0 ? (Ot.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = M) : d[3] !== void 0 && (a = M) : a === M ? d[0] === ">" ? (a = o ?? L, c = -1) : d[1] === void 0 ? c = -2 : (c = a.lastIndex - d[2].length, u = d[1], a = d[3] === void 0 ? M : d[3] === '"' ? St : $t) : a === St || a === $t ? a = M : a === kt || a === _t ? a = L : (a = M, o = void 0);
    const g = a === M && i[l + 1].startsWith("/>") ? " " : "";
    s += a === L ? n + Jt : c >= 0 ? (r.push(u), n.slice(0, c) + Ct + n.slice(c) + _ + g) : n + _ + (c === -2 ? l : g);
  }
  return [zt(i, s + (i[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class K {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    if (this.el = K.createElement(u, r), D.currentNode = this.el.content, e === 2 || e === 3) {
      const c = this.el.content.firstChild;
      c.replaceWith(...c.childNodes);
    }
    for (; (o = D.nextNode()) !== null && n.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const c of o.getAttributeNames()) if (c.endsWith(Ct)) {
          const b = d[a++], g = o.getAttribute(c).split(_), v = /([.?@])?(.*)/.exec(b);
          n.push({ type: 1, index: s, name: v[2], strings: g, ctor: v[1] === "." ? te : v[1] === "?" ? ee : v[1] === "@" ? re : rt }), o.removeAttribute(c);
        ...
        if (Ot.test(o.tagName)) {
          ...
          if (b > 0) {
            ...
            for (let g = 0; g < b; g++) o.append(c[g], q()), D.nextNode(), n.push({ type: 2, index: ++s });
            o.append(c[b], q());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Tt) n.push({ type: 2, index: s });
      else {
        let c = -1;
...
function N(i, t, e = i, r) {
  ...
  return o?.constructor !== s && (o?._$AO?.(!1), s === void 0 ? o = void 0 : (o = new s(i), o._$AT(i, e, r)), r !== void 0 ? (e._$Co ??= [])[r] = o : e._$Cl = o), o !== void 0 && (t = N(i, o._$AS(i, t.values), o, r)), t;
}
class Xt {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: r } = this._$AD, o = (t?.creationScope ?? E).importNode(e, !0);
    D.currentNode = o;
    let s = D.nextNode(), a = 0, l = 0, n = r[0];
    for (; n !== void 0; ) {
      if (a === n.index) {
        let u;
        n.type === 2 ? u = new Y(s, s.nextSibling, this, t) : n.type === 1 ? u = new n.ctor(s, n.name, n.strings, this, t) : n.type === 6 && (u = new oe(s, this, t)), this._$AV.push(u), n = r[++l];
      }
      a !== n?.index && (s = D.nextNode(), a++);
    }
    return D.currentNode = E, o;
  }
  p(t) {
    let e = 0;
...
class Y {
  ...
  _$AI(t, e = this) {
    t = N(this, t, e), V(t) ? t === w || t == null || t === "" ? (this._$AH !== w && this._$AR(), this._$AH = w) : t !== this._$AH && t !== P && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Gt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== w && V(this._$AH) ? this._$AA.nextSibling.data = t : this.T(E.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: e, _$litType$: r } = t, o = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = K.createElement(zt(r.h, r.h[0]), this.options)), r);
  ...
  k(t) {
    ...
    const e = this._$AH;
    let r, o = 0;
    for (const s of t) o === e.length ? e.push(r = new Y(this.O(q()), this.O(q()), this, this.options)) : r = e[o], r._$AI(s), o++;
...
class rt {
  ...
  _$AI(t, e = this, r, o) {
    ...
    let a = !1;
    if (s === void 0) t = N(this, t, e, 0), a = !V(t) || t !== this._$AH && t !== P, a && (this._$AH = t);
    else {
      const l = t;
      let n, u;
      for (t = s[0], n = 0; n < s.length - 1; n++) u = N(this, l[r + n], e, n), u === P && (u = this._$AH[n]), a ||= !V(u) || u !== this._$AH[n], u === w ? t = w : t !== w && (t += (u ?? "") + s[n + 1]), this._$AH[n] = u;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
const ae = nt.litHtmlPolyfillSupport;
ae?.(K, Y), (nt.litHtmlVersions ??= []).push("3.3.2");
const ie = (i, t, e) => {
  const r = e?.renderBefore ?? t;
  let o = r._$litPart$;
  if (o === void 0) {
    const s = e?.renderBefore ?? null;
    r._$litPart$ = o = new Y(t.insertBefore(q(), s), s, void 0, e ?? {});
  }
  return o._$AI(i), o;
};
const ct = globalThis;
...
W._$litElement$ = !0, W.finalized = !0, ct.litElementHydrateSupport?.({ LitElement: W });
const se = ct.litElementPolyfillSupport;
se?.({ LitElement: W });
...
class ce extends (customElements.get("ha-panel-lovelace") ? W : HTMLElement) {
...
`), r = new Blob([e], { type: "text/csv" }), o = URL.createObjectURL(r), s = document.createElement("a");
  ...
  render() {
    ...
    const n = this._data[k(/* @__PURE__ */ new Date())] || { duration: 0, target: 0 }, u = (n.duration || 0) + l, d = n.target || 8 * 3600;
    let c = 0, b = 0;
    ...
    const g = {
      ...
      soll: b / 3600,
      saldo: (c - b) / 3600
    }, v = e, J = Math.min(u / d * 100, 100), $ = 64, S = 2 * Math.PI * $, G = S - J / 100 * S;
    (/* @__PURE__ */ new Date()).toLocaleDateString("de-DE", { day: "numeric", month: "long" });
    const ot = this._currentMonth.toLocaleDateString("de-DE", { month: "short" }).toUpperCase(), C = this._currentMonth.toLocaleDateString("de-DE", { month: "long", year: "numeric" }), T = ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"], f = /* @__PURE__ */ new Date(), jt = k(f), dt = f.getDay(), Ht = dt === 0 ? -6 : 1 - dt, Z = new Date(f);
    Z.setDate(f.getDate() + Ht), Z.setHours(0, 0, 0, 0);
    const pt = [];
    let ht = 0, ut = 0;
    for (let h = 0; h < 7; h++) {
      const O = new Date(Z);
      O.setDate(Z.getDate() + h);
      const z = k(O), m = this._data[z], x = O.getDay(), B = x === 0 || x === 6, R = z === jt;
      let y = 0, A = 0, j = B ? "weekend" : "work", F = 0, Q = 0;
      if (m) {
        y = (m.duration || 0) / 3600, A = (m.target || 0) / 3600, m.type && (j = m.type === "weekend" ? "weekend" : m.type);
        const H = m.sessions || [];
        H.forEach((bt) => {
          const gt = (bt.duration || 0) / 3600;
          bt.location === "home" ? Q += gt : F += gt;
        }), H.length === 0 && y > 0 && j !== "sick" && j !== "vacation" && (F = y);
      } else B || (A = 8);
      if (R && e && l > 0) {
        const H = l / 3600;
        y += H, a === "home" ? Q += H : F += H;
      }
      ht += y, ut += A, pt.push({ label: T[O.getDay()], duration: y, target: A, type: j, offHours: F, hmHours: Q, isToday: R });
    }
    ...
    return p`
            ...
            ${v ? p`<div class="absolute -top-16 -left-16 w-64 h-64 rounded-full blur-[80px] opacity-20 pointer-events-none transition-colors duration-1000 ${Ut}"></div>` : ""}
                ...
                >
                  ...
                  <svg class="absolute inset-0 w-full h-full transform -rotate-90 drop-shadow-xl z-20" viewBox="0 0 160 160" style="pointer-events: none;">
                    ...
                    <circle cx="80" cy="80" r="${$}" class="stroke-neutral-800" stroke-width="8" fill="transparent" />
                    <circle
                      cx="80" cy="80" r="${$}"
                      class="transition-all duration-1000 ease-out ${Nt}"
                      stroke-width="8" stroke-linecap="round" fill="transparent" stroke-dasharray="${S}" stroke-dashoffset="${G}"
          ...
          <div class="bg-neutral-800/50 rounded-3xl p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="px-2.5 py-1 rounded-md bg-[#2a1a3e] border border-purple-500/20 text-purple-300 text-[10px] font-bold tracking-widest font-mono">
                    ${ht.toFixed(1)} / ${ut.toFixed(1)}h
                </div>
            </div>

            <div class="flex justify-between items-end gap-2 mt-6">
                ${pt.map((h) => {
      const O = h.type === "weekend", z = h.type === "sick", m = h.type === "vacation", x = h.isToday, B = h.offHours + h.hmHours, R = x ? "border-neutral-500/50" : "border-neutral-700/30";
      if (z || m)
        return p`
            <div class="flex flex-col items-center flex-1 group">
              <div class="relative w-full flex flex-col justify-end h-20 bg-neutral-800 rounded-lg border ${R} overflow-hidden">
                <div class="w-full ${z ? "bg-rose-500" : "bg-amber-500"} rounded-lg transition-all duration-500 ${x ? "opacity-100 shadow-[0_0_10px_rgba(225,29,72,0.3)]" : "opacity-70"}" style="height: 100%"></div>
                <div class="opacity-0 group-hover:opacity-100 absolute -top-8 left-1/2 -translate-x-1/2 bg-neutral-900 text-xs px-2 py-1 rounded border border-neutral-600 pointer-events-none transition-opacity z-20 whitespace-nowrap text-white font-mono">${z ? "Krank" : "Urlaub"}</div>
              </div>
              <span class="text-xs mt-2 font-medium ${x ? "text-white" : "text-neutral-500"}">${h.label}</span>
            </div>`;
      if ((O || h.target === 0) && B === 0)
        return p`
            <div class="flex flex-col items-center flex-1 group">
      ...
      const y = h.target > 0 ? h.target : 8, A = Math.min(h.offHours / y * 100, 100), j = Math.min(h.hmHours / y * 100, 100 - A);
      return p`
          <div class="flex flex-col items-center flex-1 group">
            <div class="relative w-full flex flex-col justify-end h-20 bg-neutral-800 rounded-lg border ${R} overflow-hidden">
              ${h.hmHours > 0 ? p`
                <div class="w-full transition-all duration-500 bg-purple-500 ${h.offHours === 0 ? "rounded-lg" : "rounded-t-lg"} ${x ? "opacity-100 shadow-[0_0_10px_rgba(168,85,247,0.3)]" : "opacity-70"}" style="height: ${j}%"></div>
              ` : ""}
              ${h.offHours > 0 ? p`
                <div class="w-full transition-all duration-500 bg-blue-500 ${h.hmHours === 0 ? "rounded-lg" : "rounded-b-lg"} ${x ? "opacity-100 shadow-[0_0_10px_rgba(59,130,246,0.3)]" : "opacity-70"}" style="height: ${A}%"></div>
              ` : ""}
              <div class="opacity-0 group-hover:opacity-100 absolute -top-8 left-1/2 -translate-x-1/2 bg-neutral-900 text-xs px-2 py-1 rounded border border-neutral-600 pointer-events-none transition-opacity z-20 whitespace-nowrap text-white font-mono">${B.toFixed(1)}h</div>
            </div>
            <span class="text-xs mt-2 font-medium ${x ? "text-white" : "text-neutral-500"}">${h.label}</span>
          </div>`;
    })}
          ...
          <div class="calendar bg-neutral-800/50 rounded-3xl p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors">
            <div class="cal-nav flex justify-between items-center mb-6 px-2">
              ...
              <span class="cal-title font-bold text-white">${C}</span>
              <button class="nav-btn p-2 hover:bg-neutral-800 rounded-full transition-colors text-white" @click=${() => this.changeMonth(1)}>
  ...
  renderCalendarDays(t, e) {
    ...
    for (let d = 1; d <= s.getDate(); d++) {
      const c = k(new Date(t.getFullYear(), t.getMonth(), d)), b = this._data[c], g = c === a, v = b?.target || 0, J = b?.duration || 0;
      let $ = "bg-neutral-800/40 hover:bg-neutral-700/80", S = "border border-neutral-700/30";
      g && (S = e === "home" ? "border border-purple-500/80 bg-purple-500/10 shadow-[0_0_15px_rgba(168,85,247,0.15)]" : "border border-blue-500/80 bg-blue-500/10 shadow-[0_0_15px_rgba(59,130,246,0.15)]");
      let G = "text-sm", ot = "font-bold", C = "text-neutral-400", T = "text-neutral-500", f = "";
      b?.type === "sick" ? (C = "text-rose-400", T = "text-rose-500", f = "Krank") : b?.type === "vacation" ? (C = "text-amber-400", T = "text-amber-500", f = "Urlaub") : J > 0 ? (f = (J / 3600).toFixed(1) + "h", C = e === "home" ? "text-purple-400" : "text-blue-400", T = e === "home" ? "text-purple-400" : "text-blue-400") : v > 0 && (f = (v / 3600).toFixed(1) + "h"), r.push(p`
          <div class="cal-cell aspect-square flex flex-col items-center justify-center rounded-xl cursor-pointer transition-colors ${$} ${S}" @click=${() => this.openDayDetail(c, b)}>
            <span class="${G} ${ot} ${C}">${d}</span>
            ${f ? p`<span class="text-[10px] font-bold tracking-wider ${T} mt-0.5">
              ${f}
            </span>` : ""}
          </div>
        `);
