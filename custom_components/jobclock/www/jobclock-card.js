const B = globalThis, Y = B.ShadowRoot && (B.ShadyCSS === void 0 || B.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ht = /* @__PURE__ */ Symbol(), et = /* @__PURE__ */ new WeakMap();
let At = class {
  constructor(t, e, r) {
...
const ut = (i) => new At(typeof i == "string" ? i : i + "", void 0, ht), Et = (i, t) => {
  if (Y) i.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else for (const e of t) {
    const r = document.createElement("style"), o = B.litNonce;
...
const { is: Dt, defineProperty: Ct, getOwnPropertyDescriptor: Mt, getOwnPropertyNames: Tt, getOwnPropertySymbols: Ot, getPrototypeOf: zt } = Object, F = globalThis, ot = F.trustedTypes, jt = ot ? ot.emptyScript : "", Ut = F.reactiveElementPolyfillSupport, O = (i, t) => i, J = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? jt : null;
      break;
  ...
  return e;
} }, bt = (i, t) => !Dt(i, t), at = { attribute: !0, type: String, converter: J, reflect: !1, useDefault: !1, hasChanged: bt };
...
let D = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(O("properties"))) {
      const e = this.properties, r = [...Tt(e), ...Ot(e)];
  ...
  _$AK(t, e) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const s = r.getPropertyOptions(o), a = typeof s.converter == "function" ? { fromAttribute: s.converter } : s.converter?.fromAttribute !== void 0 ? s.converter : J;
      this._$Em = o;
...
D.elementStyles = [], D.shadowRootOptions = { mode: "open" }, D[O("elementProperties")] = /* @__PURE__ */ new Map(), D[O("finalized")] = /* @__PURE__ */ new Map(), Ut?.({ ReactiveElement: D }), (F.reactiveElementVersions ??= []).push("2.1.2");
const G = globalThis, it = (i) => i, L = G.trustedTypes, st = L ? L.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, gt = "$lit$", x = `lit$${Math.random().toFixed(9).slice(2)}$`, wt = "?" + x, Ht = `<${wt}>`, _ = document, j = () => _.createComment(""), U = (i) => i === null || typeof i != "object" && typeof i != "function", K = Array.isArray, Pt = (i) => K(i) || typeof i?.[Symbol.iterator] == "function", V = `[ 	
\f\r]`, T = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, nt = /-->/g, lt = />/g, k = RegExp(`>|${V}(?:([^\\s"'>=/]+)(${V}*=${V}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ct = /'/g, dt = /"/g, vt = /^(?:script|style|textarea|title)$/i, Nt = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), h = Nt(1), C = /* @__PURE__ */ Symbol.for("lit-noChange"), g = /* @__PURE__ */ Symbol.for("lit-nothing"), pt = /* @__PURE__ */ new WeakMap(), $ = _.createTreeWalker(_, 129);
function ft(i, t) {
...
const Rt = (i, t) => {
  ...
  for (let l = 0; l < e; l++) {
    ...
    s += a === T ? n + Ht : c >= 0 ? (r.push(p), n.slice(0, c) + gt + n.slice(c) + x + b) : n + x + (c === -2 ? l : b);
  }
...
class H {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    this.parts = [];
    let s = 0, a = 0;
    const l = t.length - 1, n = this.parts, [p, d] = Rt(t, e);
    if (this.el = H.createElement(p, r), $.currentNode = this.el.content, e === 2 || e === 3) {
    ...
    for (; (o = $.nextNode()) !== null && n.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const c of o.getAttributeNames()) if (c.endsWith(gt)) {
          ...
          n.push({ type: 1, index: s, name: w[2], strings: b, ctor: w[1] === "." ? Lt : w[1] === "?" ? Ft : w[1] === "@" ? It : I }), o.removeAttribute(c);
...
function M(i, t, e = i, r) {
  ...
  return o?.constructor !== s && (o?._$AO?.(!1), s === void 0 ? o = void 0 : (o = new s(i), o._$AT(i, e, r)), r !== void 0 ? (e._$Co ??= [])[r] = o : e._$Cl = o), o !== void 0 && (t = M(i, o._$AS(i, t.values), o, r)), t;
}
class Bt {
  constructor(t, e) {
  ...
  u(t) {
    ...
    for (; n !== void 0; ) {
      if (a === n.index) {
        let p;
        n.type === 2 ? p = new P(s, s.nextSibling, this, t) : n.type === 1 ? p = new n.ctor(s, n.name, n.strings, this, t) : n.type === 6 && (p = new qt(s, this, t)), this._$AV.push(p), n = r[++l];
      }
...
class P {
  ...
  _$AI(t, e = this) {
    t = M(this, t, e), U(t) ? t === g || t == null || t === "" ? (this._$AH !== g && this._$AR(), this._$AH = g) : t !== this._$AH && t !== C && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Pt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: e, _$litType$: r } = t, o = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = H.createElement(ft(r.h, r.h[0]), this.options)), r);
  ...
  k(t) {
    ...
    const e = this._$AH;
    let r, o = 0;
    for (const s of t) o === e.length ? e.push(r = new P(this.O(j()), this.O(j()), this, this.options)) : r = e[o], r._$AI(s), o++;
...
class I {
  ...
  _$AI(t, e = this, r, o) {
    ...
    let a = !1;
    if (s === void 0) t = M(this, t, e, 0), a = !U(t) || t !== this._$AH && t !== C, a && (this._$AH = t);
    else {
      const l = t;
      let n, p;
      for (t = s[0], n = 0; n < s.length - 1; n++) p = M(this, l[r + n], e, n), p === C && (p = this._$AH[n]), a ||= !U(p) || p !== this._$AH[n], p === g ? t = g : t !== g && (t += (p ?? "") + s[n + 1]), this._$AH[n] = p;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
const Wt = G.litHtmlPolyfillSupport;
Wt?.(H, P), (G.litHtmlVersions ??= []).push("3.3.2");
const Vt = (i, t, e) => {
  const r = e?.renderBefore ?? t;
  let o = r._$litPart$;
  if (o === void 0) {
    const s = e?.renderBefore ?? null;
    r._$litPart$ = o = new P(t.insertBefore(j(), s), s, void 0, e ?? {});
  }
  return o._$AI(i), o;
};
const Z = globalThis;
...
`), r = new Blob([e], { type: "text/csv" }), o = URL.createObjectURL(r), s = document.createElement("a");
    s.href = o, s.download = `jobclock_export_${E(/* @__PURE__ */ new Date())}.csv`, s.click();
  }
  formatTime(t) {
  ...
  render() {
    ...
    const n = this._data[E(/* @__PURE__ */ new Date())] || { duration: 0, target: 0 }, p = (n.duration || 0) + l, d = n.target || 8 * 3600;
    let c = 0, u = 0;
    ...
    const b = {
      ...
      soll: u / 3600,
      saldo: (c - u) / 3600
    }, w = e, N = Math.min(p / d * 100, 100), m = 64, y = 2 * Math.PI * m, R = y - N / 100 * y, q = (/* @__PURE__ */ new Date()).toLocaleDateString("de-DE", { day: "numeric", month: "long" }), S = this._currentMonth.toLocaleDateString("de-DE", { month: "short" }).toUpperCase(), A = this._currentMonth.toLocaleDateString("de-DE", { month: "long", year: "numeric" }), f = 40, xt = 40, mt = [
    ...
    ], yt = a === "home" ? "bg-purple-500" : "bg-blue-500", kt = a === "home" ? "bg-purple-400" : "bg-blue-400", $t = a === "home" ? "stroke-purple-500" : "stroke-blue-500";
    return h`
        ...
        <div class="w-full max-w-md space-y-4">
          ...
          <div class="flex justify-between items-center mb-6">
            <div>
              ...
              <p class="text-neutral-400 text-sm mt-0.5 font-medium">Heute, ${q}</p>
            </div>
          ...
          <div class="bg-gradient-to-b from-neutral-800/80 to-neutral-900/80 backdrop-blur-xl rounded-3xl p-5 sm:p-6 border border-neutral-700/30 shadow-[0_8px_30px_rgba(0,0,0,0.2)] relative overflow-hidden flex flex-row items-center gap-6">
            <!-- Ambient Glow -->
            <div class="absolute -top-16 -left-16 w-64 h-64 rounded-full blur-[80px] opacity-20 pointer-events-none transition-colors duration-1000 ${yt}"></div>
                ...
                >
                  ...
                  ${w ? h`<div class="absolute inset-1.5 rounded-full animate-ping opacity-[0.15] ${kt}"></div>` : ""}
                  ...
                  <svg class="absolute inset-0 w-full h-full transform -rotate-90 drop-shadow-xl z-20" viewBox="0 0 160 160" style="pointer-events: none;">
                    ...
                    <circle
                      cx="80" cy="80" r="${m}"
                      class="transition-all duration-1000 ease-out ${$t}"
                      stroke-width="8" stroke-linecap="round" fill="transparent" stroke-dasharray="${y}" stroke-dashoffset="${R}"
                ...
                <div class="flex flex-col flex-1 h-36 relative w-full pt-1">
                    ...
                    <div class="mt-auto pb-4">
                        ...
                        <div class="w-full h-1 bg-neutral-800 rounded-full overflow-hidden">
                            <div 
                                class="h-full rounded-full transition-all duration-1000 ${a === "home" ? "bg-purple-500" : "bg-blue-500"}"
          ...
          <div class="bg-neutral-800/50 rounded-3xl p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="px-2.5 py-1 rounded-md bg-[#2a1a3e] border border-purple-500/20 text-purple-300 text-[10px] font-bold tracking-widest font-mono">
                    ${f.toFixed(1)} / ${xt.toFixed(1)}h
                </div>
            </div>

            <div class="flex justify-between items-end h-28 gap-2 mt-6">
                ${mt.map((v) => {
      const _t = v.type === "weekend", Q = v.target, X = v.duration, tt = v.label === ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"][(/* @__PURE__ */ new Date()).getDay()];
      let W = "";
      if (_t || Q === 0)
        W = h`<div class="relative w-full h-20 bg-neutral-800 rounded-lg border border-neutral-700/30 group"></div>`;
      else {
        const St = Math.min(X / Math.max(Q, 1) * 100, 100);
        W = h`
                        <div class="relative w-full flex flex-col justify-end h-20 bg-neutral-800 rounded-lg border ${tt ? "border-neutral-500/50" : "border-neutral-700/30"} group">
                            <div class="w-full ${a === "home" ? "bg-purple-500" : "bg-blue-500"} rounded-lg transition-all duration-1000 ease-out" style="height: ${St}%"></div>
      ...
      return h`
          ...
          <div class="calendar bg-neutral-800/50 rounded-3xl p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors">
            <div class="cal-nav flex justify-between items-center mb-6 px-2">
              ...
              <span class="cal-title font-bold text-white">${A}</span>
              <button class="nav-btn p-2 hover:bg-neutral-800 rounded-full transition-colors text-white" @click=${() => this.changeMonth(1)}>
  ...
  renderCalendarDays(t, e) {
    const r = [], o = new Date(t.getFullYear(), t.getMonth(), 1), s = new Date(t.getFullYear(), t.getMonth() + 1, 0), a = E(/* @__PURE__ */ new Date());
    let l = o.getDay() - 1;
    l === -1 && (l = 6);
    ...
    for (let d = 1; d <= s.getDate(); d++) {
      const c = E(new Date(t.getFullYear(), t.getMonth(), d)), u = this._data[c], b = c === a, w = u?.target || 0, N = u?.duration || 0;
      ...
      let R = "text-sm", q = "font-bold", S = "text-neutral-400", A = "text-neutral-500", f = "";
  ...
  _renderDayDetail() {
    ...
    return h`
      <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-md transition-all" @click=${this.closeDayDetail}>
        <div class="bg-[#1a1f2b] border border-neutral-700/50 rounded-[2rem] w-full max-w-sm shadow-2xl overflow-hidden flex flex-col" @click=${(a) => a.stopPropagation()}>
          ...
          <div class="px-6 pt-6 pb-4 flex justify-between items-center relative">
            <h3 class="text-lg font-bold text-white">${Gt(this._detailDate)}</h3>
    ...
    }} class="flex-1 py-1.5 text-xs font-semibold rounded-lg transition-all ${this._editType === "work" ? "bg-blue-500/10 text-blue-400 border border-blue-500/30" : "text-neutral-500 hover:text-neutral-400 border border-transparent"}">
                    Arbeit
                </button>
                <button @click=${() => {
      this._editType = "vacation", this._autoSave();
    }} class="flex-1 py-1.5 text-xs font-semibold rounded-lg transition-all ${this._editType === "vacation" ? "bg-amber-500/10 text-amber-400 border border-amber-500/30" : "text-neutral-500 hover:text-neutral-400 border border-transparent"}">
                    Urlaub
                </button>
                <button @click=${() => {
      this._editType = "sick", this._autoSave();
    }} class="flex-1 py-1.5 text-xs font-semibold rounded-lg transition-all ${this._editType === "sick" ? "bg-rose-500/10 text-rose-400 border border-rose-500/30" : "text-neutral-500 hover:text-neutral-400 border border-transparent"}">
                    Krank
                </button>
            </div>
              ...
              ${e.map((a, l) => h`
                <div class="flex items-center gap-2 p-1.5 bg-[#13161f] border border-neutral-800 rounded-xl shadow-inner">
                  ...
                  <div class="flex-1 flex items-center justify-center gap-1.5 bg-[#13161f] rounded-xl border border-neutral-800 p-1 shadow-inner">
                      <input type="time" class="bg-transparent text-white font-mono text-sm text-center outline-none min-w-[80px] [&::-webkit-calendar-picker-indicator]:opacity-0 [&::-webkit-calendar-picker-indicator]:absolute" .value=${new Date(a.start).toTimeString().slice(0, 5)} @change=${(n) => {
      a.start = `${this._detailDate}T${n.target.value}:00`, this.requestUpdate(), this._autoSave();
    }}>
                      <span class="text-neutral-500 text-xs">—</span>
                      <input type="time" class="bg-transparent text-white font-mono text-sm text-center outline-none min-w-[80px] [&::-webkit-calendar-picker-indicator]:opacity-0 [&::-webkit-calendar-picker-indicator]:absolute" .value=${new Date(a.end).toTimeString().slice(0, 5)} @change=${(n) => {
      a.end = `${this._detailDate}T${n.target.value}:00`, this.requestUpdate(), this._autoSave();
                  ...
                  <div class="flex bg-neutral-900/80 rounded-lg p-0.5 border border-neutral-700/50 shadow-inner">
                    <button @click=${() => {
      a.location = "office", this.requestUpdate(), this._autoSave();
    }} class="px-2 py-1 text-[10px] font-semibold rounded-md transition-all ${(a.location || "office") === "office" ? "bg-blue-500/10 text-blue-400" : "text-neutral-500 hover:text-neutral-400"}">
                      Büro
                    </button>
                    <button @click=${() => {
      a.location = "home", this.requestUpdate(), this._autoSave();
    }} class="px-2 py-1 text-[10px] font-semibold rounded-md transition-all ${(a.location || "office") === "home" ? "bg-purple-500/10 text-purple-400" : "text-neutral-500 hover:text-neutral-400"}">
                      Home
                    </button>
                  </div>
                  
                  <button class="text-rose-400 p-1.5 hover:bg-rose-500/20 rounded-lg transition" @click=${() => this.deleteSession(l)}>
              ...
              ${this._addFormOpen ? h`
                <div class="flex items-center gap-2 p-1.5 bg-emerald-500/5 border border-emerald-500/20 rounded-xl mt-2 shadow-inner">
                    ...
                    <div class="flex bg-neutral-900/80 rounded-lg p-0.5 border border-neutral-700/50 shadow-inner">
                      <button class="px-2 py-1 text-[10px] font-semibold rounded-md bg-blue-500/10 text-blue-400" id="new-loc-office" @click=${(a) => {
      a.target.closest("div").querySelector("#new-loc-home")?.classList.remove("bg-purple-500/10", "text-purple-400"), a.target.closest("div").querySelector("#new-loc-home")?.classList.add("text-neutral-500"), a.target.classList.add("bg-blue-500/10", "text-blue-400"), a.target.classList.remove("text-neutral-500");
    }}>
                        Büro
                      </button>
                      <button class="px-2 py-1 text-[10px] font-semibold rounded-md text-neutral-500" id="new-loc-home" @click=${(a) => {
      a.target.closest("div").querySelector("#new-loc-office")?.classList.remove("bg-blue-500/10", "text-blue-400"), a.target.closest("div").querySelector("#new-loc-office")?.classList.add("text-neutral-500"), a.target.classList.add("bg-purple-500/10", "text-purple-400"), a.target.classList.remove("text-neutral-500");
    }}>
                        Home
                      </button>
                    </div>
                    <button class="text-emerald-400 p-1.5 hover:bg-emerald-500/20 rounded-lg transition" @click=${() => {
      const a = this.renderRoot.querySelector("#new-loc-home")?.classList.contains("text-purple-400") ? "home" : "office";
      this.addSession(this.renderRoot.querySelector("#new-start").value, this.renderRoot.querySelector("#new-end").value, a);
    }}>
