...
const { is: Et, defineProperty: Dt, getOwnPropertyDescriptor: Ct, getOwnPropertyNames: Tt, getOwnPropertySymbols: Ot, getPrototypeOf: jt } = Object, L = globalThis, ot = L.trustedTypes, zt = ot ? ot.emptyScript : "", Ut = L.reactiveElementPolyfillSupport, O = (i, t) => i, Y = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? zt : null;
      break;
  ...
  return e;
} }, bt = (i, t) => !Et(i, t), at = { attribute: !0, type: String, converter: Y, reflect: !1, useDefault: !1, hasChanged: bt };
...
const K = globalThis, it = (i) => i, F = K.trustedTypes, st = F ? F.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, gt = "$lit$", x = `lit$${Math.random().toFixed(9).slice(2)}$`, wt = "?" + x, Ht = `<${wt}>`, _ = document, z = () => _.createComment(""), U = (i) => i === null || typeof i != "object" && typeof i != "function", G = Array.isArray, Pt = (i) => G(i) || typeof i?.[Symbol.iterator] == "function", V = `[ 	
\f\r]`, T = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, nt = /-->/g, lt = />/g, k = RegExp(`>|${V}(?:([^\\s"'>=/]+)(${V}*=${V}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ct = /'/g, dt = /"/g, vt = /^(?:script|style|textarea|title)$/i, Nt = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), h = Nt(1), D = /* @__PURE__ */ Symbol.for("lit-noChange"), g = /* @__PURE__ */ Symbol.for("lit-nothing"), pt = /* @__PURE__ */ new WeakMap(), $ = _.createTreeWalker(_, 129);
function ft(i, t) {
      ...
      if (o.nodeType === 1) {
        ...
        if (vt.test(o.tagName)) {
          ...
          if (u > 0) {
            ...
            for (let b = 0; b < u; b++) o.append(c[b], z()), $.nextNode(), n.push({ type: 2, index: ++s });
            o.append(c[u], z());
          }
        }
    ...
    return h`
      <div class="w-full max-w-md mx-auto space-y-4 font-sans text-neutral-100 selection:bg-purple-500/30">
          ...
          <div class="flex items-center gap-2 mb-4">
            ...
            <p class="text-neutral-400 text-sm font-medium">Heute, ${W}</p>
          </div>
