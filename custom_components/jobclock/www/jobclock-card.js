const R = globalThis, Y = R.ShadowRoot && (R.ShadyCSS === void 0 || R.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ht = /* @__PURE__ */ Symbol(), et = /* @__PURE__ */ new WeakMap();
let At = class {
  constructor(t, e, r) {
...
const ut = (i) => new At(typeof i == "string" ? i : i + "", void 0, ht), Mt = (i, t) => {
...
const { is: Et, defineProperty: Dt, getOwnPropertyDescriptor: Ct, getOwnPropertyNames: Tt, getOwnPropertySymbols: Ot, getPrototypeOf: jt } = Object, L = globalThis, ot = L.trustedTypes, zt = ot ? ot.emptyScript : "", Ut = L.reactiveElementPolyfillSupport, O = (i, t) => i, J = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? zt : null;
      break;
  ...
  return e;
} }, bt = (i, t) => !Et(i, t), at = { attribute: !0, type: String, converter: J, reflect: !1, useDefault: !1, hasChanged: bt };
...
let E = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, r) {
    const { get: o, set: s } = Ct(this.prototype, t) ?? { get() {
      return this[e];
    }, set(a) {
      this[e] = a;
    } };
...
E.elementStyles = [], E.shadowRootOptions = { mode: "open" }, E[O("elementProperties")] = /* @__PURE__ */ new Map(), E[O("finalized")] = /* @__PURE__ */ new Map(), Ut?.({ ReactiveElement: E }), (L.reactiveElementVersions ??= []).push("2.1.2");
const K = globalThis, it = (i) => i, F = K.trustedTypes, st = F ? F.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, gt = "$lit$", x = `lit$${Math.random().toFixed(9).slice(2)}$`, wt = "?" + x, Ht = `<${wt}>`, $ = document, z = () => $.createComment(""), U = (i) => i === null || typeof i != "object" && typeof i != "function", G = Array.isArray, Pt = (i) => G(i) || typeof i?.[Symbol.iterator] == "function", V = `[ 	
\f\r]`, T = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, nt = /-->/g, lt = />/g, k = RegExp(`>|${V}(?:([^\\s"'>=/]+)(${V}*=${V}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ct = /'/g, dt = /"/g, vt = /^(?:script|style|textarea|title)$/i, Nt = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), h = Nt(1), D = /* @__PURE__ */ Symbol.for("lit-noChange"), g = /* @__PURE__ */ Symbol.for("lit-nothing"), pt = /* @__PURE__ */ new WeakMap(), _ = $.createTreeWalker($, 129);
function ft(i, t) {
...
class H {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    this.parts = [];
    let s = 0, a = 0;
    const l = t.length - 1, n = this.parts, [p, d] = Bt(t, e);
    if (this.el = H.createElement(p, r), _.currentNode = this.el.content, e === 2 || e === 3) {
      const c = this.el.content.firstChild;
      c.replaceWith(...c.childNodes);
    }
    for (; (o = _.nextNode()) !== null && n.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const c of o.getAttributeNames()) if (c.endsWith(gt)) {
          const u = d[a++], b = o.getAttribute(c).split(x), w = /([.?@])?(.*)/.exec(u);
          n.push({ type: 1, index: s, name: w[2], strings: b, ctor: w[1] === "." ? Ft : w[1] === "?" ? Lt : w[1] === "@" ? It : I }), o.removeAttribute(c);
        ...
        if (vt.test(o.tagName)) {
          ...
          if (u > 0) {
            ...
            for (let b = 0; b < u; b++) o.append(c[b], z()), _.nextNode(), n.push({ type: 2, index: ++s });
            o.append(c[u], z());
          }
        }
...
class Rt {
  ...
  u(t) {
    const { el: { content: e }, parts: r } = this._$AD, o = (t?.creationScope ?? $).importNode(e, !0);
    _.currentNode = o;
    let s = _.nextNode(), a = 0, l = 0, n = r[0];
    for (; n !== void 0; ) {
      if (a === n.index) {
        let p;
        n.type === 2 ? p = new P(s, s.nextSibling, this, t) : n.type === 1 ? p = new n.ctor(s, n.name, n.strings, this, t) : n.type === 6 && (p = new Wt(s, this, t)), this._$AV.push(p), n = r[++l];
      }
      a !== n?.index && (s = _.nextNode(), a++);
    }
    return _.currentNode = $, o;
  }
  p(t) {
    let e = 0;
...
class P {
  ...
  _(t) {
    this._$AH !== g && U(this._$AH) ? this._$AA.nextSibling.data = t : this.T($.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    ...
    if (this._$AH?._$AD === o) this._$AH.p(e);
      ...
      const s = new Rt(o, this), a = s.u(this.options);
  ...
  k(t) {
    ...
    const e = this._$AH;
    let r, o = 0;
    for (const s of t) o === e.length ? e.push(r = new P(this.O(z()), this.O(z()), this, this.options)) : r = e[o], r._$AI(s), o++;
...
qt?.(H, P), (K.litHtmlVersions ??= []).push("3.3.2");
const Vt = (i, t, e) => {
  const r = e?.renderBefore ?? t;
  let o = r._$litPart$;
  if (o === void 0) {
    const s = e?.renderBefore ?? null;
    r._$litPart$ = o = new P(t.insertBefore(z(), s), s, void 0, e ?? {});
  }
  return o._$AI(i), o;
};
const Z = globalThis;
...
class Gt extends (customElements.get("ha-panel-lovelace") ? j : HTMLElement) {
...
`), r = new Blob([e], { type: "text/csv" }), o = URL.createObjectURL(r), s = document.createElement("a");
  ...
  render() {
    ...
    const b = {
      ...
      soll: u / 3600,
      saldo: (c - u) / 3600
    }, w = e, N = Math.min(p / d * 100, 100), m = 64, y = 2 * Math.PI * m, B = y - N / 100 * y, W = (/* @__PURE__ */ new Date()).toLocaleDateString("de-DE", { day: "numeric", month: "long" }), S = this._currentMonth.toLocaleDateString("de-DE", { month: "short" }).toUpperCase(), A = this._currentMonth.toLocaleDateString("de-DE", { month: "long", year: "numeric" }), f = 40, xt = 40, mt = [
    ...
    ], yt = a === "home" ? "bg-purple-500" : "bg-blue-500", kt = a === "home" ? "bg-purple-400" : "bg-blue-400", _t = a === "home" ? "stroke-purple-500" : "stroke-blue-500";
    return h`
      <div class="w-full max-w-md mx-auto space-y-4 font-sans text-neutral-100 selection:bg-purple-500/30">
          ...
          <div class="flex justify-between items-center mb-6">
            <div>
              ...
              <p class="text-neutral-400 text-sm mt-0.5 font-medium">Heute, ${W}</p>
            </div>
            ...
            <div class="absolute -top-16 -left-16 w-64 h-64 rounded-full blur-[80px] opacity-20 pointer-events-none transition-colors duration-1000 ${yt}"></div>
                ...
                >
                  ...
                  <svg class="absolute inset-0 w-full h-full transform -rotate-90 drop-shadow-xl z-20" viewBox="0 0 160 160" style="pointer-events: none;">
                    ...
                    <circle
                      cx="80" cy="80" r="${m}"
                      class="transition-all duration-1000 ease-out ${_t}"
      ...
      if ($t || Q === 0)
        ...
        q = h`
                        <div class="relative w-full flex flex-col justify-end h-20 bg-neutral-800 rounded-lg border ${tt ? "border-neutral-500/50" : "border-neutral-700/30"} overflow-hidden group">
                            <div class="w-full ${a === "home" ? "bg-purple-500" : "bg-blue-500"} rounded-b-lg transition-all duration-1000 ease-out" style="height: ${St}%"></div>
      ...
      <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-md transition-all" @click=${this.closeDayDetail}>
        <div class="bg-[#1a1f2b] border border-neutral-700/50 rounded-[2rem] w-full max-w-sm shadow-2xl overflow-hidden flex flex-col" @click=${(a) => a.stopPropagation()}>
          ...
          <div class="px-6 pt-6 pb-4 flex justify-between items-center relative">
            <h3 class="text-lg font-bold text-white">${Kt(this._detailDate)}</h3>
...
customElements.define("jobclock-card", Gt);
