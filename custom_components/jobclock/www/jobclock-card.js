...
H.elementStyles = [], H.shadowRootOptions = { mode: "open" }, H[I("elementProperties")] = /* @__PURE__ */ new Map(), H[I("finalized")] = /* @__PURE__ */ new Map(), Yt?.({ ReactiveElement: H }), (et.reactiveElementVersions ??= []).push("2.1.2");
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), $t = /'/g, St = /"/g, Ot = /^(?:script|style|textarea|title)$/i, Zt = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), p = Zt(1), U = /* @__PURE__ */ Symbol.for("lit-noChange"), w = /* @__PURE__ */ Symbol.for("lit-nothing"), At = /* @__PURE__ */ new WeakMap(), D = E.createTreeWalker(E, 129);
function zt(i, t) {
...
function P(i, t, e = i, r) {
  ...
  return o?.constructor !== s && (o?._$AO?.(!1), s === void 0 ? o = void 0 : (o = new s(i), o._$AT(i, e, r)), r !== void 0 ? (e._$Co ??= [])[r] = o : e._$Cl = o), o !== void 0 && (t = P(i, o._$AS(i, t.values), o, r)), t;
}
class Xt {
  constructor(t, e) {
...
class Y {
  ...
  _$AI(t, e = this) {
    t = P(this, t, e), V(t) ? t === w || t == null || t === "" ? (this._$AH !== w && this._$AR(), this._$AH = w) : t !== this._$AH && t !== U && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Gt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class rt {
  ...
  _$AI(t, e = this, r, o) {
    ...
    let a = !1;
    if (s === void 0) t = P(this, t, e, 0), a = !V(t) || t !== this._$AH && t !== U, a && (this._$AH = t);
    else {
      const l = t;
      let n, u;
      for (t = s[0], n = 0; n < s.length - 1; n++) u = P(this, l[r + n], e, n), u === U && (u = this._$AH[n]), a ||= !V(u) || u !== this._$AH[n], u === w ? t = w : t !== w && (t += (u ?? "") + s[n + 1]), this._$AH[n] = u;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
`), r = new Blob([e], { type: "text/csv" }), o = URL.createObjectURL(r), s = document.createElement("a");
  ...
  render() {
    ...
    for (let h = 0; h < 7; h++) {
      ...
      const z = k(O), y = this._data[z], x = O.getDay(), N = x === 0 || x === 6, B = z === jt;
      let m = 0, A = 0, Q = N ? "weekend" : "work", R = 0, F = 0;
      if (y) {
        m = (y.duration || 0) / 3600, A = (y.target || 0) / 3600, y.type && (Q = y.type === "weekend" ? "weekend" : y.type);
        const j = y.sessions || [];
        j.forEach((bt) => {
          const gt = (bt.duration || 0) / 3600;
          bt.location === "home" ? F += gt : R += gt;
        }), j.length === 0 && m > 0 && (a === "home" ? F = m : R = m);
      } else N || (A = 8);
      if (B && e && l > 0) {
        const j = l / 3600;
        m += j, a === "home" ? F += j : R += j;
      }
      ht += m, ut += A, pt.push({ label: T[O.getDay()], duration: m, target: A, type: Q, offHours: R, hmHours: F, isToday: B });
    }
    ...
    return p`
      <div class="w-full max-w-xl mx-auto space-y-4 font-sans text-neutral-100 selection:bg-purple-500/30">
          ...
          <div class="bg-neutral-800/50 rounded-3xl p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors">
            ...
            <div class="flex justify-between items-end gap-2 mt-6">
                ${pt.map((h) => {
      const O = h.type === "weekend", z = h.type === "sick", y = h.type === "vacation", x = h.isToday, N = h.offHours + h.hmHours, B = x ? "border-neutral-500/50" : "border-neutral-700/30";
      if (z || y)
        return p`
            <div class="flex flex-col items-center flex-1 group">
              <div class="relative w-full flex flex-col justify-end h-20 bg-neutral-800 rounded-lg border ${B} overflow-hidden">
      ...
      const m = h.target > 0 ? h.target : 8, A = Math.min(h.offHours / m * 100, 100), Q = Math.min(h.hmHours / m * 100, 100 - A);
      return p`
          <div class="flex flex-col items-center flex-1 group">
            <div class="relative w-full flex flex-col justify-end h-20 bg-neutral-800 rounded-lg border ${B} overflow-hidden">
              ${h.hmHours > 0 ? p`
                <div class="w-full transition-all duration-500 bg-purple-500 ${h.offHours === 0 ? "rounded-lg" : "rounded-t-lg"} ${x ? "opacity-100 shadow-[0_0_10px_rgba(168,85,247,0.3)]" : "opacity-70"}" style="height: ${Q}%"></div>
              ` : ""}
              ${h.offHours > 0 ? p`
              ...
              ` : ""}
              <div class="opacity-0 group-hover:opacity-100 absolute -top-8 left-1/2 -translate-x-1/2 bg-neutral-900 text-xs px-2 py-1 rounded border border-neutral-600 pointer-events-none transition-opacity z-20 whitespace-nowrap text-white font-mono">${N.toFixed(1)}h</div>
            </div>
            <span class="text-xs mt-2 font-medium ${x ? "text-white" : "text-neutral-500"}">${h.label}</span>
          </div>`;
    })}
