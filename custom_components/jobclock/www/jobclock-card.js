...
const { is: Ft, defineProperty: Lt, getOwnPropertyDescriptor: It, getOwnPropertyNames: Wt, getOwnPropertySymbols: qt, getPrototypeOf: Vt } = Object, et = globalThis, ft = et.trustedTypes, Kt = ft ? ft.emptyScript : "", Yt = et.reactiveElementPolyfillSupport, L = (i, t) => i, it = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Kt : null;
      break;
...
H.elementStyles = [], H.shadowRootOptions = { mode: "open" }, H[L("elementProperties")] = /* @__PURE__ */ new Map(), H[L("finalized")] = /* @__PURE__ */ new Map(), Yt?.({ ReactiveElement: H }), (et.reactiveElementVersions ??= []).push("2.1.2");
const nt = globalThis, mt = (i) => i, tt = nt.trustedTypes, yt = tt ? tt.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Ct = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, Tt = "?" + _, Jt = `<${Tt}>`, E = document, W = () => E.createComment(""), q = (i) => i === null || typeof i != "object" && typeof i != "function", lt = Array.isArray, Gt = (i) => lt(i) || typeof i?.[Symbol.iterator] == "function", at = `[ 	
\f\r]`, F = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, kt = /-->/g, _t = />/g, M = RegExp(`>|${at}(?:([^\\s"'>=/]+)(${at}*=${at}*(?:[^ 	
...
const Qt = (i, t) => {
  ...
  let o, s = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", a = F;
  for (let l = 0; l < e; l++) {
    const n = i[l];
    let u, d, c = -1, b = 0;
    for (; b < n.length && (a.lastIndex = b, d = a.exec(n), d !== null); ) b = a.lastIndex, a === F ? d[1] === "!--" ? a = kt : d[1] !== void 0 ? a = _t : d[2] !== void 0 ? (Ot.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = M) : d[3] !== void 0 && (a = M) : a === M ? d[0] === ">" ? (a = o ?? F, c = -1) : d[1] === void 0 ? c = -2 : (c = a.lastIndex - d[2].length, u = d[1], a = d[3] === void 0 ? M : d[3] === '"' ? St : $t) : a === St || a === $t ? a = M : a === kt || a === _t ? a = F : (a = M, o = void 0);
    const g = a === M && i[l + 1].startsWith("/>") ? " " : "";
    s += a === F ? n + Jt : c >= 0 ? (r.push(u), n.slice(0, c) + Ct + n.slice(c) + _ + g) : n + _ + (c === -2 ? l : g);
  }
...
class V {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    if (this.el = V.createElement(u, r), D.currentNode = this.el.content, e === 2 || e === 3) {
      ...
      if (o.nodeType === 1) {
        ...
        if (Ot.test(o.tagName)) {
          ...
          if (b > 0) {
            ...
            for (let g = 0; g < b; g++) o.append(c[g], W()), D.nextNode(), n.push({ type: 2, index: ++s });
            o.append(c[b], W());
          }
        }
...
class Xt {
  ...
  u(t) {
    ...
    for (; n !== void 0; ) {
      if (a === n.index) {
        let u;
        n.type === 2 ? u = new K(s, s.nextSibling, this, t) : n.type === 1 ? u = new n.ctor(s, n.name, n.strings, this, t) : n.type === 6 && (u = new oe(s, this, t)), this._$AV.push(u), n = r[++l];
      }
...
class K {
  ...
  _$AI(t, e = this) {
    t = P(this, t, e), q(t) ? t === w || t == null || t === "" ? (this._$AH !== w && this._$AR(), this._$AH = w) : t !== this._$AH && t !== U && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Gt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== w && q(this._$AH) ? this._$AA.nextSibling.data = t : this.T(E.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: e, _$litType$: r } = t, o = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = V.createElement(zt(r.h, r.h[0]), this.options)), r);
  ...
  k(t) {
    ...
    const e = this._$AH;
    let r, o = 0;
    for (const s of t) o === e.length ? e.push(r = new K(this.O(W()), this.O(W()), this, this.options)) : r = e[o], r._$AI(s), o++;
...
class rt {
  ...
  _$AI(t, e = this, r, o) {
    ...
    let a = !1;
    if (s === void 0) t = P(this, t, e, 0), a = !q(t) || t !== this._$AH && t !== U, a && (this._$AH = t);
    else {
      const l = t;
      let n, u;
      for (t = s[0], n = 0; n < s.length - 1; n++) u = P(this, l[r + n], e, n), u === U && (u = this._$AH[n]), a ||= !q(u) || u !== this._$AH[n], u === w ? t = w : t !== w && (t += (u ?? "") + s[n + 1]), this._$AH[n] = u;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
ae?.(V, K), (nt.litHtmlVersions ??= []).push("3.3.2");
const ie = (i, t, e) => {
  const r = e?.renderBefore ?? t;
  let o = r._$litPart$;
  if (o === void 0) {
    const s = e?.renderBefore ?? null;
    r._$litPart$ = o = new K(t.insertBefore(W(), s), s, void 0, e ?? {});
  }
  return o._$AI(i), o;
};
const ct = globalThis;
...
I._$litElement$ = !0, I.finalized = !0, ct.litElementHydrateSupport?.({ LitElement: I });
...
class ce extends (customElements.get("ha-panel-lovelace") ? I : HTMLElement) {
...
`), r = new Blob([e], { type: "text/csv" }), o = URL.createObjectURL(r), s = document.createElement("a");
  ...
  render() {
    ...
    const g = {
      ...
      soll: b / 3600,
      saldo: (c - b) / 3600
    }, v = e, Y = Math.min(u / d * 100, 100), $ = 64, S = 2 * Math.PI * $, J = S - Y / 100 * S;
    (/* @__PURE__ */ new Date()).toLocaleDateString("de-DE", { day: "numeric", month: "long" });
    const ot = this._currentMonth.toLocaleDateString("de-DE", { month: "short" }).toUpperCase(), C = this._currentMonth.toLocaleDateString("de-DE", { month: "long", year: "numeric" }), T = ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"], f = /* @__PURE__ */ new Date(), jt = k(f), dt = f.getDay(), Ht = dt === 0 ? -6 : 1 - dt, G = new Date(f);
    G.setDate(f.getDate() + Ht), G.setHours(0, 0, 0, 0);
    const pt = [];
    let ht = 0, ut = 0;
    for (let h = 0; h < 7; h++) {
      const O = new Date(G);
      O.setDate(G.getDate() + h);
      const z = k(O), m = this._data[z], x = O.getDay(), N = x === 0 || x === 6, B = z === jt;
      let y = 0, A = 0, Z = N ? "weekend" : "work", R = 0, Q = 0;
      if (m) {
        y = (m.duration || 0) / 3600, A = (m.target || 0) / 3600, m.type && (Z = m.type === "weekend" ? "weekend" : m.type);
        const j = m.sessions || [];
        j.forEach((bt) => {
          const gt = (bt.duration || 0) / 3600;
          bt.location === "home" ? Q += gt : R += gt;
        }), j.length === 0 && y > 0 && (R = y);
      } else N || (A = 8);
      if (B && e && l > 0) {
        const j = l / 3600;
      ...
      ht += y, ut += A, pt.push({ label: T[O.getDay()], duration: y, target: A, type: Z, offHours: R, hmHours: Q, isToday: B });
    }
    ...
    return p`
      <div class="w-full max-w-xl mx-auto space-y-4 font-sans text-neutral-100 selection:bg-purple-500/30">
                ...
                >
                  ...
                  <svg class="absolute inset-0 w-full h-full transform -rotate-90 drop-shadow-xl z-20" viewBox="0 0 160 160" style="pointer-events: none;">
                    ...
                    <circle
                      ...
                      stroke-width="8" stroke-linecap="round" fill="transparent" stroke-dasharray="${S}" stroke-dashoffset="${J}"
          ...
          <div class="bg-neutral-800/50 rounded-3xl p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors">
            ...
            <div class="flex justify-between items-end gap-2 mt-6">
                ${pt.map((h) => {
      const O = h.type === "weekend", z = h.type === "sick", m = h.type === "vacation", x = h.isToday, N = h.offHours + h.hmHours, B = x ? "border-neutral-500/50" : "border-neutral-700/30";
      if (z || m)
        return p`
      ...
      const y = h.target > 0 ? h.target : 8, A = Math.min(h.offHours / y * 100, 100), Z = Math.min(h.hmHours / y * 100, 100 - A);
      return p`
          <div class="flex flex-col items-center flex-1 group">
            <div class="relative w-full flex flex-col justify-end h-20 bg-neutral-800 rounded-lg border ${B} overflow-hidden">
              ${h.hmHours > 0 ? p`
                <div class="w-full transition-all duration-500 bg-purple-500 ${h.offHours === 0 ? "rounded-lg" : "rounded-t-lg"} ${x ? "opacity-100 shadow-[0_0_10px_rgba(168,85,247,0.3)]" : "opacity-70"}" style="height: ${Z}%"></div>
              ` : ""}
              ${h.offHours > 0 ? p`
  ...
  renderCalendarDays(t, e) {
    ...
    for (let d = 1; d <= s.getDate(); d++) {
      const c = k(new Date(t.getFullYear(), t.getMonth(), d)), b = this._data[c], g = c === a, v = b?.target || 0, Y = b?.duration || 0;
      ...
      let J = "text-sm", ot = "font-bold", C = "text-neutral-400", T = "text-neutral-500", f = "";
      b?.type === "sick" ? (C = "text-rose-400", T = "text-rose-500", f = "Krank") : b?.type === "vacation" ? (C = "text-amber-400", T = "text-amber-500", f = "Urlaub") : Y > 0 ? (f = (Y / 3600).toFixed(1) + "h", C = e === "home" ? "text-purple-400" : "text-blue-400", T = e === "home" ? "text-purple-400" : "text-blue-400") : v > 0 && (f = (v / 3600).toFixed(1) + "h"), r.push(p`
