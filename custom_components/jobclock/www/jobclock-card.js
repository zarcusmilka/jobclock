const at = globalThis, ht = at.ShadowRoot && (at.ShadyCSS === void 0 || at.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Et = /* @__PURE__ */ Symbol(), ft = /* @__PURE__ */ new WeakMap();
let Rt = class {
  constructor(t, e, r) {
...
const Ct = (i) => new Rt(typeof i == "string" ? i : i + "", void 0, Et), Bt = (i, t) => {
...
const { is: Lt, defineProperty: Ft, getOwnPropertyDescriptor: It, getOwnPropertyNames: Wt, getOwnPropertySymbols: qt, getPrototypeOf: Vt } = Object, st = globalThis, mt = st.trustedTypes, Kt = mt ? mt.emptyScript : "", Yt = st.reactiveElementPolyfillSupport, J = (i, t) => i, pt = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Kt : null;
      break;
  ...
  return e;
} }, Tt = (i, t) => !Lt(i, t), yt = { attribute: !0, type: String, converter: pt, reflect: !1, useDefault: !1, hasChanged: Tt };
...
let R = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, r) {
    const { get: o, set: s } = It(this.prototype, t) ?? { get() {
      return this[e];
    }, set(a) {
      this[e] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(J("properties"))) {
      const e = this.properties, r = [...Wt(e), ...qt(e)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const o of r) e.unshift(xt(o));
  ...
  _$ET(t, e) {
    ...
    if (o !== void 0 && r.reflect === !0) {
      const s = (r.converter?.toAttribute !== void 0 ? r.converter : pt).toAttribute(e, r.type);
  ...
  _$AK(t, e) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const s = r.getPropertyOptions(o), a = typeof s.converter == "function" ? { fromAttribute: s.converter } : s.converter?.fromAttribute !== void 0 ? s.converter : pt;
      this._$Em = o;
  ...
  requestUpdate(t, e, r, o = !1, s) {
    if (t !== void 0) {
      ...
      if (o === !1 && (s = this[t]), r ??= a.getPropertyOptions(t), !((r.hasChanged ?? Tt)(s, e) || r.useDefault && r.reflect && s === this._$Ej?.get(t) && !this.hasAttribute(a._$Eu(t, r)))) return;
      this.C(t, e, r);
    }
...
R.elementStyles = [], R.shadowRootOptions = { mode: "open" }, R[J("elementProperties")] = /* @__PURE__ */ new Map(), R[J("finalized")] = /* @__PURE__ */ new Map(), Yt?.({ ReactiveElement: R }), (st.reactiveElementVersions ??= []).push("2.1.2");
const ut = globalThis, kt = (i) => i, it = ut.trustedTypes, _t = it ? it.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, zt = "$lit$", $ = `lit$${Math.random().toFixed(9).slice(2)}$`, Ot = "?" + $, Jt = `<${Ot}>`, z = document, Z = () => z.createComment(""), Q = (i) => i === null || typeof i != "object" && typeof i != "function", bt = Array.isArray, Gt = (i) => bt(i) || typeof i?.[Symbol.iterator] == "function", dt = `[ 	
\f\r]`, Y = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, $t = /-->/g, St = />/g, C = RegExp(`>|${dt}(?:([^\\s"'>=/]+)(${dt}*=${dt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), At = /'/g, Dt = /"/g, jt = /^(?:script|style|textarea|title)$/i, Zt = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), h = Zt(1), B = /* @__PURE__ */ Symbol.for("lit-noChange"), w = /* @__PURE__ */ Symbol.for("lit-nothing"), Mt = /* @__PURE__ */ new WeakMap(), T = z.createTreeWalker(z, 129);
function Ht(i, t) {
...
const Qt = (i, t) => {
  ...
  let o, s = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", a = Y;
  for (let l = 0; l < e; l++) {
    const n = i[l];
    let u, d, c = -1, b = 0;
    for (; b < n.length && (a.lastIndex = b, d = a.exec(n), d !== null); ) b = a.lastIndex, a === Y ? d[1] === "!--" ? a = $t : d[1] !== void 0 ? a = St : d[2] !== void 0 ? (jt.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = C) : d[3] !== void 0 && (a = C) : a === C ? d[0] === ">" ? (a = o ?? Y, c = -1) : d[1] === void 0 ? c = -2 : (c = a.lastIndex - d[2].length, u = d[1], a = d[3] === void 0 ? C : d[3] === '"' ? Dt : At) : a === Dt || a === At ? a = C : a === $t || a === St ? a = Y : (a = C, o = void 0);
    const g = a === C && i[l + 1].startsWith("/>") ? " " : "";
    s += a === Y ? n + Jt : c >= 0 ? (r.push(u), n.slice(0, c) + zt + n.slice(c) + $ + g) : n + $ + (c === -2 ? l : g);
  }
  return [Ht(i, s + (i[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class X {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    this.parts = [];
    let s = 0, a = 0;
    const l = t.length - 1, n = this.parts, [u, d] = Qt(t, e);
    if (this.el = X.createElement(u, r), T.currentNode = this.el.content, e === 2 || e === 3) {
      const c = this.el.content.firstChild;
      c.replaceWith(...c.childNodes);
    }
    for (; (o = T.nextNode()) !== null && n.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const c of o.getAttributeNames()) if (c.endsWith(zt)) {
          const b = d[a++], g = o.getAttribute(c).split($), v = /([.?@])?(.*)/.exec(b);
          n.push({ type: 1, index: s, name: v[2], strings: g, ctor: v[1] === "." ? te : v[1] === "?" ? ee : v[1] === "@" ? re : nt }), o.removeAttribute(c);
        ...
        if (jt.test(o.tagName)) {
          ...
          if (b > 0) {
            ...
            for (let g = 0; g < b; g++) o.append(c[g], Z()), T.nextNode(), n.push({ type: 2, index: ++s });
            o.append(c[b], Z());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Ot) n.push({ type: 2, index: s });
      else {
        let c = -1;
...
function L(i, t, e = i, r) {
  if (t === B) return t;
  let o = r !== void 0 ? e._$Co?.[r] : e._$Cl;
  const s = Q(t) ? void 0 : t._$litDirective$;
  return o?.constructor !== s && (o?._$AO?.(!1), s === void 0 ? o = void 0 : (o = new s(i), o._$AT(i, e, r)), r !== void 0 ? (e._$Co ??= [])[r] = o : e._$Cl = o), o !== void 0 && (t = L(i, o._$AS(i, t.values), o, r)), t;
}
class Xt {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: r } = this._$AD, o = (t?.creationScope ?? z).importNode(e, !0);
    T.currentNode = o;
    let s = T.nextNode(), a = 0, l = 0, n = r[0];
    for (; n !== void 0; ) {
      if (a === n.index) {
        let u;
        n.type === 2 ? u = new tt(s, s.nextSibling, this, t) : n.type === 1 ? u = new n.ctor(s, n.name, n.strings, this, t) : n.type === 6 && (u = new oe(s, this, t)), this._$AV.push(u), n = r[++l];
      }
      a !== n?.index && (s = T.nextNode(), a++);
    }
    return T.currentNode = z, o;
  }
  p(t) {
    let e = 0;
...
class tt {
  ...
  constructor(t, e, r, o) {
    this.type = 2, this._$AH = w, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = r, this.options = o, this._$Cv = o?.isConnected ?? !0;
  }
  get parentNode() {
  ...
  _$AI(t, e = this) {
    t = L(this, t, e), Q(t) ? t === w || t == null || t === "" ? (this._$AH !== w && this._$AR(), this._$AH = w) : t !== this._$AH && t !== B && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Gt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== w && Q(this._$AH) ? this._$AA.nextSibling.data = t : this.T(z.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: e, _$litType$: r } = t, o = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = X.createElement(Ht(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === o) this._$AH.p(e);
    else {
      const s = new Xt(o, this), a = s.u(this.options);
      s.p(e), this.T(a), this._$AH = s;
    }
  }
  _$AC(t) {
    let e = Mt.get(t.strings);
    return e === void 0 && Mt.set(t.strings, e = new X(t)), e;
  }
  k(t) {
    bt(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let r, o = 0;
    for (const s of t) o === e.length ? e.push(r = new tt(this.O(Z()), this.O(Z()), this, this.options)) : r = e[o], r._$AI(s), o++;
...
class nt {
  ...
  constructor(t, e, r, o, s) {
    this.type = 1, this._$AH = w, this._$AN = void 0, this.element = t, this.name = e, this._$AM = o, this.options = s, r.length > 2 || r[0] !== "" || r[1] !== "" ? (this._$AH = Array(r.length - 1).fill(new String()), this.strings = r) : this._$AH = w;
  }
  _$AI(t, e = this, r, o) {
    const s = this.strings;
    let a = !1;
    if (s === void 0) t = L(this, t, e, 0), a = !Q(t) || t !== this._$AH && t !== B, a && (this._$AH = t);
    else {
      const l = t;
      let n, u;
      for (t = s[0], n = 0; n < s.length - 1; n++) u = L(this, l[r + n], e, n), u === B && (u = this._$AH[n]), a ||= !Q(u) || u !== this._$AH[n], u === w ? t = w : t !== w && (t += (u ?? "") + s[n + 1]), this._$AH[n] = u;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
class re extends nt {
  ...
  _$AI(t, e = this) {
    if ((t = L(this, t, e, 0) ?? w) === B) return;
    const r = this._$AH, o = t === w && r !== w || t.capture !== r.capture || t.once !== r.once || t.passive !== r.passive, s = t !== w && (r === w || o);
...
ae?.(X, tt), (ut.litHtmlVersions ??= []).push("3.3.2");
const ie = (i, t, e) => {
  const r = e?.renderBefore ?? t;
  let o = r._$litPart$;
  if (o === void 0) {
    const s = e?.renderBefore ?? null;
    r._$litPart$ = o = new tt(t.insertBefore(Z(), s), s, void 0, e ?? {});
  }
  return o._$AI(i), o;
};
const gt = globalThis;
...
class ce extends (customElements.get("ha-panel-lovelace") ? G : HTMLElement) {
  ...
  constructor() {
    super(), this._data = {}, this._currentMonth = /* @__PURE__ */ new Date(), this._detailOpen = !1, this._editorOpen = !1, this._editSessions = [], this._editType = "work";
  }
  setConfig(t) {
    this.config = t;
  }
  ...
  openDayDetail(t, e) {
    this._detailDate = t, this._detailData = e || { duration: 0, type: "work", sessions: [] }, this._editSessions = JSON.parse(JSON.stringify(this._detailData.sessions || [])), this._editType = this._detailData.type || "work", this._detailOpen = !0, this._editorOpen = !0;
  }
  closeDayDetail() {
    this._detailOpen = !1;
  }
  ...
  addSession(t, e, r) {
    ...
    this._editSessions = [...this._editSessions, {
      ...
      duration: l,
      location: r || "office"
    }], this.requestUpdate(), this._autoSave();
  }
  exportToCSV() {
...
`), r = new Blob([e], { type: "text/csv" }), o = URL.createObjectURL(r), s = document.createElement("a");
    s.href = o, s.download = `jobclock_export_${_(/* @__PURE__ */ new Date())}.csv`, s.click();
  }
  formatTime(t) {
  ...
  render() {
    ...
    const n = this._data[_(/* @__PURE__ */ new Date())] || { duration: 0, target: 0 }, u = (n.duration || 0) + l, d = n.target || 8 * 3600;
    let c = 0, b = 0;
    Object.values(this._data).forEach((p) => {
      c += p.duration || 0, b += p.target || 0;
    }), e && (c += l);
    const g = {
      ist: c / 3600,
      soll: b / 3600,
      saldo: (c - b) / 3600
    }, v = e, S = Math.min(u / d * 100, 100), A = 64, D = 2 * Math.PI * A, O = D - S / 100 * D;
    (/* @__PURE__ */ new Date()).toLocaleDateString("de-DE", { day: "numeric", month: "long" });
    const et = this._currentMonth.toLocaleDateString("de-DE", { month: "short" }).toUpperCase(), F = this._currentMonth.toLocaleDateString("de-DE", { month: "long", year: "numeric" }), lt = ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"], M = /* @__PURE__ */ new Date(), ct = _(M), rt = M.getDay(), j = rt === 0 ? -6 : 1 - rt, x = new Date(M);
    x.setDate(M.getDate() + j), x.setHours(0, 0, 0, 0);
    const m = [];
    let I = 0, W = 0;
    for (let p = 0; p < 7; p++) {
      const H = new Date(x);
      H.setDate(x.getDate() + p);
      const U = _(H), y = this._data[U], f = H.getDay(), q = f === 0 || f === 6, V = U === ct;
      let k = 0, E = 0, P = q ? "weekend" : "work", K = 0, ot = 0;
      if (y) {
        k = (y.duration || 0) / 3600, E = (y.target || 0) / 3600, y.type && (P = y.type === "weekend" ? "weekend" : y.type);
        const N = y.sessions || [];
        N.forEach((wt) => {
          const vt = (wt.duration || 0) / 3600;
          wt.location === "home" ? ot += vt : K += vt;
        }), N.length === 0 && k > 0 && P !== "sick" && P !== "vacation" && (K = k);
      } else q || (E = 8);
      if (V && e && l > 0) {
        const N = l / 3600;
        k += N, a === "home" ? ot += N : K += N;
      }
      I += k, W += E, m.push({ label: lt[H.getDay()], duration: k, target: E, type: P, offHours: K, hmHours: ot, isToday: V });
    }
    const Ut = a === "home" ? "bg-purple-500" : "bg-blue-500", Pt = a === "home" ? "bg-purple-400" : "bg-blue-400", Nt = a === "home" ? "stroke-purple-500" : "stroke-blue-500";
    return h`
      <div class="w-full max-w-xl mx-auto space-y-4 font-sans text-neutral-100 selection:bg-purple-500/30">
          ...
          <div class="${v ? "bg-gradient-to-b from-neutral-800/80 to-neutral-900/80 backdrop-blur-xl rounded-3xl p-5 sm:p-6 border border-neutral-700/30 shadow-[0_8px_30px_rgba(0,0,0,0.2)]" : "bg-neutral-800/50 rounded-3xl p-5 sm:p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors"} relative overflow-hidden flex flex-row items-center gap-6">
            ...
            ${v ? h`<div class="absolute -top-16 -left-16 w-64 h-64 rounded-full blur-[80px] opacity-20 pointer-events-none transition-colors duration-1000 ${Ut}"></div>` : ""}
                ...
                >
                  ...
                  ${v ? h`<div class="absolute inset-1.5 rounded-full animate-ping opacity-[0.15] ${Pt}"></div>` : ""}
                  ...
                  <svg class="absolute inset-0 w-full h-full transform -rotate-90 drop-shadow-xl z-20" viewBox="0 0 160 160" style="pointer-events: none;">
                    ...
                    <circle cx="80" cy="80" r="${A}" class="stroke-neutral-800" stroke-width="8" fill="transparent" />
                    <circle
                      cx="80" cy="80" r="${A}"
                      class="transition-all duration-1000 ease-out ${Nt}"
                      stroke-width="8" stroke-linecap="round" fill="transparent" stroke-dasharray="${D}" stroke-dashoffset="${O}"
                  ...
                  <div class="absolute flex flex-col items-center justify-center text-center mt-1 z-30">
                    <div class="mb-1 transition-colors duration-300 ${v ? a === "home" ? "text-purple-400" : "text-blue-400" : "text-neutral-400 group-hover:text-purple-400"}">
                       ${v ? h`<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><rect width="18" height="18" x="3" y="3" rx="2"/></svg>` : h`<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><polygon points="6 3 20 12 6 21 6 3"/></svg>`}
                    </div>
                    ...
                    <div class="mt-auto pb-4">
                        ...
                        <div class="flex justify-between items-end mb-2">
                            <div class="flex items-baseline gap-1">
                                <span class="text-2xl font-light text-white font-mono">${g.ist.toFixed(1)}h</span>
                                <span class="text-[11px] font-medium text-neutral-500">/ ${g.soll.toFixed(1)}h</span>
                            </div>
                            <div class="flex items-center justify-center px-2 py-0.5 rounded-md text-[10px] font-bold tracking-wide ${g.saldo >= 0 ? "bg-emerald-500/10 text-emerald-400" : "bg-rose-500/10 text-rose-400"}">
                        ...
                        <div class="w-full h-1.5 bg-neutral-900/80 rounded-full overflow-hidden shadow-inner border border-neutral-700/30">
                            <div 
                                ...
                                style="width: ${Math.min(g.ist / Math.max(g.soll, 1) * 100, 100)}%"
                            ></div>
                        </div>
                    </div>
                </div>
          ...
          <div class="bg-neutral-800/50 rounded-3xl p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="px-2.5 py-1 rounded-md bg-[#2a1a3e] border border-purple-500/20 text-purple-300 text-[10px] font-bold tracking-widest font-mono">
                    ${I.toFixed(1)} / ${W.toFixed(1)}h
                </div>
            </div>

            <div class="flex justify-between items-end gap-2 mt-6">
                ${m.map((p) => {
      const H = p.type === "weekend", U = p.type === "sick", y = p.type === "vacation", f = p.isToday, q = p.offHours + p.hmHours, V = f ? "border-neutral-500/50" : "border-neutral-700/30";
      if (U || y)
        return h`
            <div class="flex flex-col items-center flex-1 group">
              <div class="relative w-full flex flex-col justify-end h-20 bg-neutral-800 rounded-lg border ${V} overflow-hidden">
                <div class="w-full ${U ? "bg-rose-500" : "bg-amber-500"} rounded-lg transition-all duration-500 ${f ? "opacity-100 shadow-[0_0_10px_rgba(225,29,72,0.3)]" : "opacity-70"}" style="height: 100%"></div>
                <div class="opacity-0 group-hover:opacity-100 absolute -top-8 left-1/2 -translate-x-1/2 bg-neutral-900 text-xs px-2 py-1 rounded border border-neutral-600 pointer-events-none transition-opacity z-20 whitespace-nowrap text-white font-mono">${U ? "Krank" : "Urlaub"}</div>
              </div>
              <span class="text-xs mt-2 font-medium ${f ? "text-white" : "text-neutral-500"}">${p.label}</span>
            </div>`;
      if ((H || p.target === 0) && q === 0)
        return h`
            <div class="flex flex-col items-center flex-1 group">
      ...
      const k = p.target > 0 ? p.target : 8, E = Math.min(p.offHours / k * 100, 100), P = Math.min(p.hmHours / k * 100, 100 - E);
      return h`
          <div class="flex flex-col items-center flex-1 group">
            <div class="relative w-full flex flex-col justify-end h-20 bg-neutral-800 rounded-lg border ${V} overflow-hidden">
              ${p.hmHours > 0 ? h`
                <div class="w-full transition-all duration-500 bg-purple-500 ${p.offHours === 0 ? "rounded-lg" : "rounded-t-lg"} ${f ? "opacity-100 shadow-[0_0_10px_rgba(168,85,247,0.3)]" : "opacity-70"}" style="height: ${P}%"></div>
              ` : ""}
              ${p.offHours > 0 ? h`
                <div class="w-full transition-all duration-500 bg-blue-500 ${p.hmHours === 0 ? "rounded-lg" : "rounded-b-lg"} ${f ? "opacity-100 shadow-[0_0_10px_rgba(59,130,246,0.3)]" : "opacity-70"}" style="height: ${E}%"></div>
              ` : ""}
              <div class="opacity-0 group-hover:opacity-100 absolute -top-8 left-1/2 -translate-x-1/2 bg-neutral-900 text-xs px-2 py-1 rounded border border-neutral-600 pointer-events-none transition-opacity z-20 whitespace-nowrap text-white font-mono">${q.toFixed(1)}h</div>
            </div>
            <span class="text-xs mt-2 font-medium ${f ? "text-white" : "text-neutral-500"}">${p.label}</span>
          </div>`;
    })}
          ...
          <div class="calendar bg-neutral-800/50 rounded-3xl p-6 border border-purple-500/10 hover:border-purple-500/20 transition-colors">
            <div class="cal-nav flex justify-between items-center mb-6 px-2">
              ...
              <span class="cal-title font-bold text-white">${F}</span>
              <button class="nav-btn p-2 hover:bg-neutral-800 rounded-full transition-colors text-white" @click=${() => this.changeMonth(1)}>
                 <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="m9 18 6-6-6-6"/></svg>
              </button>
            </div>
            <div class="cal-grid grid grid-cols-7 gap-1.5 sm:gap-2">
              ${["Mo", "Di", "Mi", "Do", "Fr", "Sa", "So"].map((p) => h`<div class="cal-hdr text-center text-[10px] font-bold text-neutral-500 mb-2">${p}</div>`)}
  ...
  renderCalendarDays(t, e) {
    const r = [], o = new Date(t.getFullYear(), t.getMonth(), 1), s = new Date(t.getFullYear(), t.getMonth() + 1, 0), a = _(/* @__PURE__ */ new Date());
    let l = o.getDay() - 1;
    l === -1 && (l = 6);
    ...
    for (let d = 1; d <= s.getDate(); d++) {
      const c = _(new Date(t.getFullYear(), t.getMonth(), d)), b = this._data[c], g = c === a, v = b?.target || 0;
      let S = b?.duration || 0;
      const A = this.hass.states[this.config.entity].attributes.is_working, D = this.hass.states[this.config.entity].attributes.session_start;
      g && A && D && (S += Math.floor((Date.now() - new Date(D).getTime()) / 1e3));
      let O = 0, et = 0;
      b?.sessions?.length > 0 ? b.sessions.forEach((I) => {
        const W = (I.duration || 0) / 3600;
        I.location === "home" ? et += W : O += W;
      }) : S > 0 && b?.type !== "sick" && b?.type !== "vacation" && (O = S / 3600);
      const F = et > O ? "home" : "office";
      let lt = "bg-neutral-800/40 hover:bg-neutral-700/80", M = "border border-neutral-700/30";
      g && (M = F === "home" ? "border border-purple-500/80 bg-purple-500/10 shadow-[0_0_15px_rgba(168,85,247,0.15)]" : "border border-blue-500/80 bg-blue-500/10 shadow-[0_0_15px_rgba(59,130,246,0.15)]");
      let ct = "text-sm", rt = "font-bold", j = "text-neutral-400", x = "text-neutral-500", m = "";
      b?.type === "sick" ? (j = "text-rose-400", x = "text-rose-500", m = "Krank") : b?.type === "vacation" ? (j = "text-amber-400", x = "text-amber-500", m = "Urlaub") : S > 0 ? (m = (S / 3600).toFixed(1) + "h", j = F === "home" ? "text-purple-400" : "text-blue-400", x = F === "home" ? "text-purple-400" : "text-blue-400") : v > 0 && (m = (v / 3600).toFixed(1) + "h"), r.push(h`
          <div class="cal-cell aspect-square flex flex-col items-center justify-center rounded-xl cursor-pointer transition-colors ${lt} ${M}" @click=${() => this.openDayDetail(c, b)}>
            <span class="${ct} ${rt} ${j}">${d}</span>
            ${m ? h`<span class="text-[10px] font-bold tracking-wider ${x} mt-0.5">
              ${m}
            </span>` : ""}
          </div>
        `);
  ...
  _renderDayDetail() {
    const t = this._detailData, e = this._editSessions, o = (e.reduce((a, l) => {
      const n = new Date(l.start).getTime(), u = new Date(l.end).getTime();
      return a + (isNaN(n) || isNaN(u) ? 0 : (u - n) / 1e3);
    ...
    return h`
      <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-md transition-all" @click=${this.closeDayDetail}>
        <div class="bg-[#1a1f2b] border border-neutral-700/50 rounded-[2rem] w-full max-w-sm shadow-2xl overflow-hidden flex flex-col" @click=${(a) => a.stopPropagation()}>
          ...
          <div class="px-6 pt-6 pb-4 flex justify-between items-center relative">
            <h3 class="text-lg font-bold text-white">${le(this._detailDate)}</h3>
      ...
      a.end = `${this._detailDate}T${n.target.value}:00`, this.requestUpdate(), this._autoSave();
              ...
              `)}
              ${e.length === 0 ? h`<div class="text-neutral-500 text-sm text-center py-4">Keine Einträge</div>` : ""}
...
customElements.define("jobclock-card", ce);
