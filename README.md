...
[![GitHub Tag](https://img.shields.io/badge/version-1.5.1-blue.svg)](https://github.com/zarcusmilka/jobclock/tags)
...
> [!IMPORTANT]
> **Mobile UX Excellence (v1.5.1)**: Radically compact header for mobile. Direct day editing (no extra click). Larger stats and touch targets. Optimized for the Home Assistant app.
